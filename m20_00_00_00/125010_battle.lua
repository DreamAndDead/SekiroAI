...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    if arg1:HasSpecialEffectId(TARGET_SELF, 200030) then
        ...
        f2_local0[6] = get_weight_base_on_cooldown(arg1, arg2, 3006, 20, f2_local0[6], 1)
        f2_local0[7] = get_weight_base_on_cooldown(arg1, arg2, 3007, 15, f2_local0[7], 1)
        f2_local0[8] = get_weight_base_on_cooldown(arg1, arg2, 3010, 8, f2_local0[8], 1)
        f2_local0[9] = get_weight_base_on_cooldown(arg1, arg2, 3011, 8, f2_local0[9], 1)
