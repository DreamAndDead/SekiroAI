...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    f2_local0[7] = get_weight_base_on_cooldown(arg1, arg2, 3020, 15, f2_local0[7], 1)
    f2_local0[8] = get_weight_base_on_cooldown(arg1, arg2, 3021, 15, f2_local0[8], 1)
    ...
    f2_local0[13] = get_weight_base_on_cooldown(arg1, arg2, 3011, 15, f2_local0[13], 1)
    f2_local0[14] = get_weight_base_on_cooldown(arg1, arg2, 3014, 15, f2_local0[14], 1)
    f2_local0[15] = get_weight_base_on_cooldown(arg1, arg2, 3014, 15, f2_local0[15], 1)
    f2_local0[18] = get_weight_base_on_cooldown(arg1, arg2, 3040, 15, f2_local0[18], 1)
    f2_local0[30] = get_weight_base_on_cooldown(arg1, arg2, 3006, 15, f2_local0[30], 1)
    ...
    f2_local0[38] = get_weight_base_on_cooldown(arg1, arg2, 3006, 15, f2_local0[38], 1)
...
Goal.Interrupt = function (arg0, arg1, arg2)
    ...
    if arg1:IsInterupt(INTERUPT_ActivateSpecialEffect) then
        if f26_local0 == SP_SHINOBI_JUDGMENT then
            arg1:SetNumber(0, 0)
            return true
        elseif f26_local0 == SP_AI_INT_JUDGMENT_ADDITION_PLAYED and arg1:HasSpecialEffectId(TARGET_SELF, SP_AI_INT_JUDGMENT_PARRIED_AND_STRONG_ATTACK) then
            arg2:ClearSubGoal()
        ...
        elseif f26_local0 == SP_ROUNDHOUSE_KICK_HIT then
            if f26_local3 <= 50 and arg1:HasSpecialEffectId(TARGET_SELF, SP_BEHAVIOR_PATTERN_CHANGE_0) then
                arg2:ClearSubGoal()
        ...
        elseif f26_local0 == SP_ENEMY_AI_REFERENCE_DEDICATED_RESPONSE_IAI_STANCE then
            arg1:Replanning()
            return true
        end
    end
    if Interupt_Use_Item(arg1, 8, 5) then
        if arg1:HasSpecialEffectId(TARGET_SELF, SP_BEHAVIOR_PATTERN_CHANGE_1) and f26_local4 >= 2 then
...
Goal.Parry = function (arg0, arg1, arg2, arg3)
    ...
    local f27_local5 = arg0:HasSpecialEffectId(TARGET_ENE_0, SP_PUSH)
    local f27_local6 = arg0:HasSpecialEffectId(TARGET_ENE_0, SP_CONTINUOUS_ATTACK)
    local f27_local7 = 2
...
Goal.Damaged = function (arg0, arg1, arg2)
    ...
    if f28_local3 <= 15 then
        ...
        return true
    elseif f28_local3 <= 30 and arg0:HasSpecialEffectId(TARGET_SELF, SP_BEHAVIOR_PATTERN_CHANGE_0) then
        arg1:ClearSubGoal()
...
Goal.Kengeki_Activate = function (arg0, arg1, arg2, arg3)
    local f30_local0 = get_kengeki_sp(arg1)
    ...
    elseif f30_local0 == SP_PARRY_COUNT_RIGHT then
        f30_local1[2] = 100
        f30_local1[17] = 100
        f30_local1[38] = 50
        f30_local1[31] = 50
    elseif f30_local0 == SP_PARRY_COUNT_LEFT then
        f30_local1[2] = 100
        f30_local1[10] = 50
        f30_local1[31] = 50
        f30_local1[38] = 50
    ...
    f30_local1[1] = get_weight_base_on_cooldown(arg1, arg2, 3050, 8, f30_local1[1], 1)
    f30_local1[2] = get_weight_base_on_cooldown(arg1, arg2, 5201, 10, f30_local1[2], 1)
    f30_local1[3] = get_weight_base_on_cooldown(arg1, arg2, 3009, 10, f30_local1[3], 1)
    f30_local1[4] = get_weight_base_on_cooldown(arg1, arg2, 3055, 8, f30_local1[4], 1)
    f30_local1[7] = get_weight_base_on_cooldown(arg1, arg2, 3060, 8, f30_local1[7], 1)
    f30_local1[9] = get_weight_base_on_cooldown(arg1, arg2, 3018, 8, f30_local1[9], 1)
    f30_local1[10] = get_weight_base_on_cooldown(arg1, arg2, 3065, 8, f30_local1[10], 1)
    f30_local1[13] = get_weight_base_on_cooldown(arg1, arg2, 3075, 8, f30_local1[13], 1)
    f30_local1[14] = get_weight_base_on_cooldown(arg1, arg2, 3076, 8, f30_local1[14], 1)
    f30_local1[15] = get_weight_base_on_cooldown(arg1, arg2, 3031, 15, f30_local1[15], 1)
    f30_local1[17] = get_weight_base_on_cooldown(arg1, arg2, 3071, 8, f30_local1[17], 1)
    f30_local1[18] = get_weight_base_on_cooldown(arg1, arg2, 3004, 8, f30_local1[18], 1)
    f30_local1[20] = get_weight_base_on_cooldown(arg1, arg2, 5202, 15, f30_local1[20], 1)
    f30_local1[30] = get_weight_base_on_cooldown(arg1, arg2, 3063, 15, f30_local1[30], 1)
    f30_local1[31] = get_weight_base_on_cooldown(arg1, arg2, 3068, 15, f30_local1[31], 1)
    f30_local1[32] = get_weight_base_on_cooldown(arg1, arg2, 3018, 15, f30_local1[32], 1)
    f30_local1[33] = get_weight_base_on_cooldown(arg1, arg2, 3007, 15, f30_local1[33], 1)
    f30_local1[34] = get_weight_base_on_cooldown(arg1, arg2, 3037, 15, f30_local1[34], 1)
    f30_local1[35] = get_weight_base_on_cooldown(arg1, arg2, 3016, 8, f30_local1[35], 1)
    f30_local1[38] = get_weight_base_on_cooldown(arg1, arg2, 3030, 8, f30_local1[38], 1)
    f30_local1[39] = get_weight_base_on_cooldown(arg1, arg2, 3034, 15, f30_local1[39], 1)
    f30_local1[40] = get_weight_base_on_cooldown(arg1, arg2, 3028, 15, f30_local1[40], 1)
    f30_local1[41] = get_weight_base_on_cooldown(arg1, arg2, 3020, 15, f30_local1[41], 1)
    f30_local1[43] = get_weight_base_on_cooldown(arg1, arg2, 3062, 15, f30_local1[43], 1)
    f30_local1[44] = get_weight_base_on_cooldown(arg1, arg2, 3067, 15, f30_local1[44], 1)
    f30_local1[45] = get_weight_base_on_cooldown(arg1, arg2, 3032, 15, f30_local1[45], 1)
