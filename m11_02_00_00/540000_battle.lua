...
Goal.Interrupt = function (arg0, arg1, arg2)
    ...
    if arg1:IsInterupt(INTERUPT_ActivateSpecialEffect) then
        ...
        elseif f37_local0 == 5032 and f37_local1 <= 3 - arg1:GetMapHitRadius(TARGET_SELF) then
            ...
            return true
        elseif f37_local0 == 5034 and arg1:HasSpecialEffectId(TARGET_SELF, SP_BEHAVIOR_PATTERN_CHANGE_0) then
        ...
        elseif f37_local0 == 110114 and arg1:HasSpecialEffectId(TARGET_SELF, 3540020) then
            ...
            return true
        elseif f37_local0 == SP_ENEMY_AI_REFERENCE_DEDICATED_RESPONSE_IAI_STANCE then
            arg1:Replanning()
            return true
        end
    end
...
Goal.Kengeki_Activate = function (arg0, arg1, arg2, arg3)
    local f39_local0 = get_kengeki_sp(arg1)
    ...
    if f39_local5 <= 0 then
        ...
        if f39_local6 <= 2 and arg1:HasSpecialEffectId(TARGET_SELF, SP_BEHAVIOR_PATTERN_CHANGE_0) then
            f39_local1[40] = 100
        ...
        elseif f39_local0 == SP_PARRY_COUNT_RIGHT then
            f39_local1[9] = 100
            f39_local1[11] = 100
            f39_local1[4] = 100
    ...
    f39_local1[1] = get_weight_base_on_cooldown(arg1, arg2, 3071, 8, f39_local1[1], 1)
    f39_local1[2] = get_weight_base_on_cooldown(arg1, arg2, 3060, 8, f39_local1[2], 1)
    f39_local1[3] = get_weight_base_on_cooldown(arg1, arg2, 3075, 8, f39_local1[3], 1)
    f39_local1[4] = get_weight_base_on_cooldown(arg1, arg2, 3007, 12, f39_local1[4], 1)
    f39_local1[4] = get_weight_base_on_cooldown(arg1, arg2, 3072, 12, f39_local1[4], 1)
    f39_local1[4] = get_weight_base_on_cooldown(arg1, arg2, 3077, 12, f39_local1[4], 1)
    f39_local1[5] = get_weight_base_on_cooldown(arg1, arg2, 3009, 12, f39_local1[5], 1)
    f39_local1[6] = get_weight_base_on_cooldown(arg1, arg2, 3011, 12, f39_local1[6], 1)
    f39_local1[7] = get_weight_base_on_cooldown(arg1, arg2, 3026, 8, f39_local1[7], 1)
    f39_local1[8] = get_weight_base_on_cooldown(arg1, arg2, 5201, 15, f39_local1[8], 1)
    f39_local1[9] = get_weight_base_on_cooldown(arg1, arg2, 3071, 15, f39_local1[9], 1)
    f39_local1[11] = get_weight_base_on_cooldown(arg1, arg2, 3003, 15, f39_local1[11], 1)
    f39_local1[12] = get_weight_base_on_cooldown(arg1, arg2, 3005, 8, f39_local1[12], 1)
    f39_local1[13] = get_weight_base_on_cooldown(arg1, arg2, 3016, 8, f39_local1[13], 1)
    f39_local1[14] = get_weight_base_on_cooldown(arg1, arg2, 3077, 8, f39_local1[14], 1)
    f39_local1[15] = get_weight_base_on_cooldown(arg1, arg2, 3011, 15, f39_local1[15], 1)
    f39_local1[17] = get_weight_base_on_cooldown(arg1, arg2, 3009, 8, f39_local1[17], 1)
    f39_local1[20] = get_weight_base_on_cooldown(arg1, arg2, 5201, 10, f39_local1[20], 1)
    f39_local1[21] = get_weight_base_on_cooldown(arg1, arg2, 3050, 15, f39_local1[21], 1)
    f39_local1[22] = get_weight_base_on_cooldown(arg1, arg2, 3044, 15, f39_local1[22], 1)
    f39_local1[31] = get_weight_base_on_cooldown(arg1, arg2, 3072, 15, f39_local1[22], 1)
