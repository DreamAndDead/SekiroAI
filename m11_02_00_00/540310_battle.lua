...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    f2_local0[1] = get_weight_base_on_cooldown(arg1, arg2, 3000, 20, f2_local0[1], 1)
    f2_local0[2] = get_weight_base_on_cooldown(arg1, arg2, 3004, 20, f2_local0[2], 1)
    f2_local0[3] = get_weight_base_on_cooldown(arg1, arg2, 3004, 20, f2_local0[3], 1)
    f2_local0[4] = get_weight_base_on_cooldown(arg1, arg2, 3007, 20, f2_local0[4], 1)
    f2_local0[5] = get_weight_base_on_cooldown(arg1, arg2, 3010, 20, f2_local0[5], 1)
    f2_local0[6] = get_weight_base_on_cooldown(arg1, arg2, 3009, 20, f2_local0[6], 1)
    f2_local0[6] = get_weight_base_on_cooldown(arg1, arg2, 3056, 20, f2_local0[6], 1)
    f2_local0[8] = get_weight_base_on_cooldown(arg1, arg2, 3020, 30, f2_local0[8], 1)
    f2_local0[9] = get_weight_base_on_cooldown(arg1, arg2, 3012, 20, f2_local0[9], 1)
    f2_local0[10] = get_weight_base_on_cooldown(arg1, arg2, 3013, 20, f2_local0[10], 1)
    f2_local0[11] = get_weight_base_on_cooldown(arg1, arg2, 3015, 20, f2_local0[11], 1)
    f2_local0[12] = get_weight_base_on_cooldown(arg1, arg2, 3024, 20, f2_local0[12], 1)
    f2_local0[13] = get_weight_base_on_cooldown(arg1, arg2, 3022, 20, f2_local0[13], 1)
    f2_local0[13] = get_weight_base_on_cooldown(arg1, arg2, 3055, 20, f2_local0[13], 1)
    f2_local0[14] = get_weight_base_on_cooldown(arg1, arg2, 3022, 20, f2_local0[14], 1)
    f2_local0[16] = get_weight_base_on_cooldown(arg1, arg2, 3000, 20, f2_local0[16], 1)
    f2_local0[40] = get_weight_base_on_cooldown(arg1, arg2, 3004, 20, f2_local0[40], 1)
    f2_local0[41] = get_weight_base_on_cooldown(arg1, arg2, 3013, 20, f2_local0[41], 1)
    f2_local0[42] = get_weight_base_on_cooldown(arg1, arg2, 3032, 20, f2_local0[42], 1)
    f2_local0[43] = get_weight_base_on_cooldown(arg1, arg2, 3030, 20, f2_local0[43], 1)
    f2_local0[44] = get_weight_base_on_cooldown(arg1, arg2, 3010, 20, f2_local0[44], 1)
    f2_local0[45] = get_weight_base_on_cooldown(arg1, arg2, 3090, 30, f2_local0[45], 1)
    f2_local0[46] = get_weight_base_on_cooldown(arg1, arg2, 3039, 25, f2_local0[46], 1)
    f2_local0[46] = get_weight_base_on_cooldown(arg1, arg2, 3040, 25, f2_local0[46], 1)
    f2_local0[48] = get_weight_base_on_cooldown(arg1, arg2, 3040, 25, f2_local0[48], 1)
    f2_local0[48] = get_weight_base_on_cooldown(arg1, arg2, 3039, 25, f2_local0[48], 1)
...
Goal.Kengeki_Activate = function (arg0, arg1, arg2, arg3)
    ...
    f53_local1[1] = get_weight_base_on_cooldown(arg1, arg2, 3013, 8, f53_local1[1], 1)
    f53_local1[2] = get_weight_base_on_cooldown(arg1, arg2, 3000, 15, f53_local1[2], 1)
    f53_local1[3] = get_weight_base_on_cooldown(arg1, arg2, 3012, 15, f53_local1[3], 1)
    f53_local1[4] = get_weight_base_on_cooldown(arg1, arg2, 3022, 15, f53_local1[4], 1)
    f53_local1[4] = get_weight_base_on_cooldown(arg1, arg2, 3055, 15, f53_local1[4], 1)
    f53_local1[5] = get_weight_base_on_cooldown(arg1, arg2, 3011, 15, f53_local1[5], 1)
    f53_local1[6] = get_weight_base_on_cooldown(arg1, arg2, 3019, 15, f53_local1[6], 1)
    f53_local1[7] = get_weight_base_on_cooldown(arg1, arg2, 3011, 15, f53_local1[7], 1)
    f53_local1[8] = get_weight_base_on_cooldown(arg1, arg2, 3031, 30, f53_local1[8], 1)
    f53_local1[8] = get_weight_base_on_cooldown(arg1, arg2, 3032, 30, f53_local1[8], 1)
    f53_local1[11] = get_weight_base_on_cooldown(arg1, arg2, 3031, 30, f53_local1[11], 1)
    f53_local1[11] = get_weight_base_on_cooldown(arg1, arg2, 3032, 30, f53_local1[11], 1)
    f53_local1[20] = get_weight_base_on_cooldown(arg1, arg2, 5201, 15, f53_local1[20], 1)
    f53_local1[30] = get_weight_base_on_cooldown(arg1, arg2, 3006, 15, f53_local1[30], 1)
    f53_local1[30] = get_weight_base_on_cooldown(arg1, arg2, 3014, 15, f53_local1[30], 1)
    f53_local1[31] = get_weight_base_on_cooldown(arg1, arg2, 3017, 15, f53_local1[31], 1)
    f53_local1[32] = get_weight_base_on_cooldown(arg1, arg2, 3018, 15, f53_local1[32], 1)
    f53_local1[33] = get_weight_base_on_cooldown(arg1, arg2, 3031, 15, f53_local1[33], 1)
    f53_local1[34] = get_weight_base_on_cooldown(arg1, arg2, 3032, 15, f53_local1[34], 1)
    f53_local1[35] = get_weight_base_on_cooldown(arg1, arg2, 3060, 15, f53_local1[35], 1)
    f53_local1[36] = get_weight_base_on_cooldown(arg1, arg2, 3065, 15, f53_local1[36], 1)
    f53_local1[37] = get_weight_base_on_cooldown(arg1, arg2, 3026, 15, f53_local1[37], 1)
    f53_local1[38] = get_weight_base_on_cooldown(arg1, arg2, 3066, 10, f53_local1[38], 1)
