...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    f2_local0[7] = get_weight_base_on_cooldown(arg1, arg2, 3011, 20, f2_local0[7], 1)
    ...
    f2_local0[45] = get_weight_base_on_cooldown(arg1, arg2, 3090, 30, f2_local0[45], 0)
...
Goal.Interrupt = function (arg0, arg1, arg2)
    ...
    if arg1:IsInterupt(INTERUPT_ActivateSpecialEffect) then
        if f41_local0 == SP_PLAYER_DOWN and arg1:HasSpecialEffectId(TARGET_SELF, 3540050) then
            arg2:ClearSubGoal()
...
Goal.Kengeki_Activate = function (arg0, arg1, arg2, arg3)
    local f42_local0 = get_kengeki_sp(arg1)
    ...
    elseif f42_local0 == SP_PARRY_COUNT_RIGHT then
        if f42_local4 >= 5 then
            f42_local1[50] = 100
            f42_local1[11] = 50
        else
    ...
    elseif f42_local0 == SP_PARRY_COUNT_LEFT then
        if f42_local4 >= 5 then
            f42_local1[50] = 100
            f42_local1[8] = 50
        else
    ...
    f42_local1[1] = get_weight_base_on_cooldown(arg1, arg2, 3013, 8, f42_local1[1], 1)
    f42_local1[2] = get_weight_base_on_cooldown(arg1, arg2, 3000, 15, f42_local1[2], 1)
    f42_local1[3] = get_weight_base_on_cooldown(arg1, arg2, 3012, 15, f42_local1[3], 1)
    f42_local1[4] = get_weight_base_on_cooldown(arg1, arg2, 3022, 15, f42_local1[4], 1)
    f42_local1[4] = get_weight_base_on_cooldown(arg1, arg2, 3055, 15, f42_local1[4], 1)
    f42_local1[5] = get_weight_base_on_cooldown(arg1, arg2, 3011, 15, f42_local1[5], 1)
    f42_local1[6] = get_weight_base_on_cooldown(arg1, arg2, 3019, 15, f42_local1[6], 1)
    f42_local1[7] = get_weight_base_on_cooldown(arg1, arg2, 3011, 15, f42_local1[7], 1)
    f42_local1[8] = get_weight_base_on_cooldown(arg1, arg2, 3031, 30, f42_local1[8], 1)
    f42_local1[8] = get_weight_base_on_cooldown(arg1, arg2, 3032, 30, f42_local1[8], 1)
    f42_local1[11] = get_weight_base_on_cooldown(arg1, arg2, 3031, 30, f42_local1[11], 1)
    f42_local1[11] = get_weight_base_on_cooldown(arg1, arg2, 3032, 30, f42_local1[11], 1)
    f42_local1[20] = get_weight_base_on_cooldown(arg1, arg2, 5201, 15, f42_local1[20], 1)
    f42_local1[30] = get_weight_base_on_cooldown(arg1, arg2, 3006, 15, f42_local1[30], 1)
    f42_local1[30] = get_weight_base_on_cooldown(arg1, arg2, 3014, 15, f42_local1[30], 1)
    f42_local1[31] = get_weight_base_on_cooldown(arg1, arg2, 3017, 15, f42_local1[31], 1)
    f42_local1[32] = get_weight_base_on_cooldown(arg1, arg2, 3018, 15, f42_local1[32], 1)
    f42_local1[33] = get_weight_base_on_cooldown(arg1, arg2, 3031, 15, f42_local1[33], 1)
    f42_local1[34] = get_weight_base_on_cooldown(arg1, arg2, 3032, 15, f42_local1[34], 1)
    f42_local1[35] = get_weight_base_on_cooldown(arg1, arg2, 3060, 15, f42_local1[35], 1)
    f42_local1[36] = get_weight_base_on_cooldown(arg1, arg2, 3065, 15, f42_local1[36], 1)
    f42_local1[37] = get_weight_base_on_cooldown(arg1, arg2, 3026, 15, f42_local1[37], 1)
    f42_local1[38] = get_weight_base_on_cooldown(arg1, arg2, 3066, 10, f42_local1[38], 1)
