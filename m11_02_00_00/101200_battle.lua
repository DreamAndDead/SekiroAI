...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    f2_local0[2] = get_weight_base_on_cooldown(arg1, arg2, 3003, 15, f2_local0[2], 1)
    f2_local0[3] = get_weight_base_on_cooldown(arg1, arg2, 3004, 8, f2_local0[3], 1)
    f2_local0[4] = get_weight_base_on_cooldown(arg1, arg2, 3010, 8, f2_local0[4], 1)
    f2_local0[5] = get_weight_base_on_cooldown(arg1, arg2, 3031, 8, f2_local0[5], 1)
    f2_local0[6] = get_weight_base_on_cooldown(arg1, arg2, 3003, 8, f2_local0[6], 1)
    f2_local0[7] = get_weight_base_on_cooldown(arg1, arg2, 3002, 8, f2_local0[7], 1)
    f2_local0[8] = get_weight_base_on_cooldown(arg1, arg2, 3033, 8, f2_local0[8], 1)
    f2_local0[9] = get_weight_base_on_cooldown(arg1, arg2, 3034, 8, f2_local0[9], 1)
    f2_local0[10] = get_weight_base_on_cooldown(arg1, arg2, 3035, 8, f2_local0[10], 1)
    f2_local0[40] = get_weight_base_on_cooldown(arg1, arg2, 3000, 8, f2_local0[40], 1)
    f2_local0[41] = get_weight_base_on_cooldown(arg1, arg2, 3012, 8, f2_local0[41], 1)
    f2_local0[42] = get_weight_base_on_cooldown(arg1, arg2, 3003, 8, f2_local0[42], 1)
    f2_local0[43] = get_weight_base_on_cooldown(arg1, arg2, 3004, 8, f2_local0[43], 1)
    f2_local0[44] = get_weight_base_on_cooldown(arg1, arg2, 3031, 30, f2_local0[44], 1)
...
Goal.Parry = function (arg0, arg1, arg2)
    ...
    if arg0:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_F, 90) and arg0:IsInsideTargetEx(TARGET_ENE_0, TARGET_SELF, AI_DIR_TYPE_F, 90, 3) then
        if f27_local5 then
            ...
            return true
        elseif arg0:IsTargetGuard(TARGET_SELF) and get_kengeki_sp(arg0) == false then
...
Goal.Kengeki_Activate = function (arg0, arg1, arg2, arg3)
    ...
    f28_local1[1] = get_weight_base_on_cooldown(arg1, arg2, 3000, 5, f28_local1[1], 1)
    f28_local1[2] = get_weight_base_on_cooldown(arg1, arg2, 3013, 15, f28_local1[2], 1)
    f28_local1[3] = get_weight_base_on_cooldown(arg1, arg2, 3014, 8, f28_local1[3], 1)
    f28_local1[4] = get_weight_base_on_cooldown(arg1, arg2, 3010, 8, f28_local1[4], 1)
    f28_local1[5] = get_weight_base_on_cooldown(arg1, arg2, 3030, 8, f28_local1[5], 1)
    f28_local1[6] = get_weight_base_on_cooldown(arg1, arg2, 3013, 8, f28_local1[6], 1)
    f28_local1[20] = get_weight_base_on_cooldown(arg1, arg2, 3032, 8, f28_local1[20], 1)
    f28_local1[21] = get_weight_base_on_cooldown(arg1, arg2, 3012, 8, f28_local1[21], 1)
