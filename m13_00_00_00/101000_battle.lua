...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    if arg1:IsInsideTargetEx(TARGET_ENE_0, TARGET_SELF, AI_DIR_TYPE_F, 120, 9999) or arg1:HasSpecialEffectId(TARGET_SELF, SP_PUPPET_SHINOBI) then
    ...
    f2_local0[3] = get_weight_base_on_cooldown(arg1, arg2, 3003, 5, f2_local0[3], 1)
    f2_local0[4] = get_weight_base_on_cooldown(arg1, arg2, 3004, 10, f2_local0[4], 1)
    f2_local0[5] = get_weight_base_on_cooldown(arg1, arg2, 3005, 10, f2_local0[5], 1)
    f2_local0[6] = get_weight_base_on_cooldown(arg1, arg2, 3008, 10, f2_local0[6], 1)
    f2_local0[7] = get_weight_base_on_cooldown(arg1, arg2, 3009, 5, f2_local0[7], 1)
    f2_local0[8] = get_weight_base_on_cooldown(arg1, arg2, 3010, 15, f2_local0[8], 1)
    f2_local0[9] = get_weight_base_on_cooldown(arg1, arg2, 3011, 15, f2_local0[9], 1)
    f2_local0[11] = get_weight_base_on_cooldown(arg1, arg2, 3012, 5, f2_local0[11], 1)
    f2_local0[14] = get_weight_base_on_cooldown(arg1, arg2, 3014, 5, f2_local0[14], 1)
    f2_local0[15] = get_weight_base_on_cooldown(arg1, arg2, 3015, 5, f2_local0[15], 1)
    f2_local0[24] = get_weight_base_on_cooldown(arg1, arg2, 5211, 5, f2_local0[24], 1)
...
Goal.Kengeki_Activate = function (arg0, arg1, arg2)
    ...
    elseif f29_local0 == SP_PARRY_COUNT_RIGHT or f29_local0 == 200215 then
        if f29_local4 >= 2.7 then

        elseif f29_local4 <= 0.2 then

        elseif f29_local0 == SP_PARRY_COUNT_RIGHT and arg1:HasSpecialEffectId(TARGET_SELF, 310080) then
            f29_local1[3] = 100
    ...
    elseif f29_local0 == SP_PARRY_COUNT_LEFT or f29_local0 == 200216 then
        if f29_local4 >= 2.7 then

        elseif f29_local4 <= 0.2 then

        elseif f29_local0 == SP_PARRY_COUNT_LEFT and arg1:HasSpecialEffectId(TARGET_SELF, 310080) then
            f29_local1[3] = 100
