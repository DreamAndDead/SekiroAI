Goal.Activate = function(self, pawn, planner)
    ...
    pawn:AddObserveSpecialEffectAttribute(TARGET_SELF, 3710020)
    pawn:AddObserveSpecialEffectAttribute(TARGET_SELF, 3710030)
    pawn:AddObserveSpecialEffectAttribute(TARGET_SELF, 3710031)

    pawn:AddObserveSpecialEffectAttribute(TARGET_ENE_0, 110010)
    pawn:AddObserveSpecialEffectAttribute(TARGET_ENE_0, 3710050)
    pawn:AddObserveSpecialEffectAttribute(TARGET_ENE_0, 110620)
    ...
    if pawn:HasSpecialEffectId(TARGET_ENE_0, 110060) or pawn:HasSpecialEffectId(TARGET_ENE_0, 110010) then
        if pawn:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_F, 90) then
            act_weights[21] = 1
            act_weights[28] = 100
        else
            act_weights[21] = 100
    ...
    elseif pawn:GetNumber(7) == 0 and pawn:HasSpecialEffectId(TARGET_SELF, 200050) then
        act_weights[15] = 600
    elseif pawn:HasSpecialEffectId(TARGET_ENE_0, 110030) then
        act_weights[28] = 100
    elseif pawn:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_B, 180) then
        act_weights[21] = 100
        act_weights[22] = 1
    elseif pawn:HasSpecialEffectId(TARGET_ENE_0, 110060) or pawn:HasSpecialEffectId(TARGET_ENE_0, 110010) then
        act_weights[27] = 100
    ...
    if (pawn:HasSpecialEffectId(TARGET_ENE_0, 109031) or pawn:HasSpecialEffectId(TARGET_ENE_0, 110125)) and dist_to_player <= 5 then
        act_weights[16] = 100
    end
    if pawn:HasSpecialEffectId(TARGET_ENE_0, 109900) then
        act_weights[1] = 5
        act_weights[2] = 5
        act_weights[3] = 5
        act_weights[9] = 0
    ...
    if pawn:HasSpecialEffectId(TARGET_SELF, 200051) then
        act_weights[15] = 0
        act_weights[18] = 0
        act_weights[19] = 0
        act_weights[34] = 0
    ...
    if SpaceCheck(pawn, planner, 45, 2) == false and SpaceCheck(pawn, planner, -45, 2) == false then
        act_weights[22] = 0
    end
    if SpaceCheck(pawn, planner, 90, 1) == false and SpaceCheck(pawn, planner, -90, 1) == false then
        act_weights[23] = 0
    end
    if SpaceCheck(pawn, planner, 180, 2) == false then
        act_weights[24] = 0
    end
    if SpaceCheck(pawn, planner, 180, 1) == false then
        act_weights[25] = 0
    end
    if pawn:HasSpecialEffectId(TARGET_ENE_0, 110621) then
        act_weights[23] = 0
        act_weights[24] = 0
        act_weights[31] = 10
    end
...
Goal.Act01 = function(arg0, arg1, arg2)
    ...
    if f3_local7 <= 30 then
        arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, 3000, TARGET_ENE_0, f3_local8, f3_local11, f3_local12, 0,
            0)
...
Goal.Act27 = function(arg0, arg1, arg2)
    ...
    arg1:AddSubGoal(GOAL_COMMON_SidewayMove, f20_local4, TARGET_ENE_0, arg0:GetRandam_Int(0, 1), f20_local5, true, true,
        -1)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
end
...
Goal.Interrupt = function(self, pawn, planner)
    local f26_local0 = pawn:GetSpecialEffectActivateInterruptType(0)
    local f26_local2 = pawn:GetDist(TARGET_ENE_0)
    local f26_local3 = pawn:GetRandam_Int(1, 100)
    local f26_local4 = pawn:GetNinsatsuNum()
    ...
    if pawn:IsInterupt(INTERUPT_ActivateSpecialEffect) then
        if f26_local0 == 3710020 then
            pawn:SetNumber(0, 0)
            return true
        elseif f26_local0 == 3710030 and pawn:HasSpecialEffectId(TARGET_SELF, 3710032) then
        ...
        elseif f26_local0 == 3710050 then
            if f26_local3 <= 50 and pawn:HasSpecialEffectId(TARGET_SELF, 200050) then
                planner:ClearSubGoal()
    ...
    if Interupt_Use_Item(pawn, 8, 5) then
        if pawn:HasSpecialEffectId(TARGET_SELF, 200051) and f26_local4 >= 2 then
...
Goal.Parry = function(pawn, planner, arg2, arg3)
    ...
    local f27_local5 = pawn:HasSpecialEffectId(TARGET_ENE_0, 109970)
    ...
    if pawn:IsFinishTimer(AI_TIMER_PARRY_INTERVAL) == false then
        return false
    end
    ...
    pawn:SetTimer(AI_TIMER_PARRY_INTERVAL, 0.1)
    ...
    if pawn:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_F, 90) and pawn:IsInsideTargetEx(TARGET_ENE_0, TARGET_SELF, AI_DIR_TYPE_F, 180, parry_dist) then
    ...
    elseif pawn:IsInsideTargetEx(TARGET_ENE_0, TARGET_SELF, AI_DIR_TYPE_F, 90, parry_dist + 1) then
...
Goal.Damaged = function(pawn, planner)
    ...
    if percent_rand <= 15 then
        ...
        return true
    elseif percent_rand <= 30 and pawn:HasSpecialEffectId(TARGET_SELF, 200050) then
        planner:ClearSubGoal()
...
Goal.Kengeki_Activate = function(self, pawn, planner)
    ...
    if pawn:HasSpecialEffectId(TARGET_SELF, 200051) then
        ...
        act_weights[39] = 0
        act_weights[46] = 0
    elseif pawn:HasSpecialEffectId(TARGET_SELF, 200050) then
        act_weights[20] = 0
    end
    if SpaceCheck(pawn, planner, 45, 2) == false and SpaceCheck(pawn, planner, -45, 2) == false then
        act_weights[20] = 0
