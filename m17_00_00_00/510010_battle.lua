...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    elseif arg1:GetNumber(1) == 1 or arg1:HasSpecialEffectId(TARGET_ENE_0, SP_ENEMY_AI_REFERENCE_SHINOBI) then
    ...
    f2_local0[3] = get_weight_base_on_cooldown(arg1, arg2, 3004, 8, f2_local0[3], 1)
    f2_local0[4] = get_weight_base_on_cooldown(arg1, arg2, 3005, 8, f2_local0[4], 1)
    f2_local0[5] = get_weight_base_on_cooldown(arg1, arg2, 3006, 8, f2_local0[5], 1)
    f2_local0[6] = get_weight_base_on_cooldown(arg1, arg2, 3007, 12, f2_local0[6], 0)
    f2_local0[6] = get_weight_base_on_cooldown(arg1, arg2, 3050, 12, f2_local0[6], 0)
    f2_local0[7] = get_weight_base_on_cooldown(arg1, arg2, 3009, 8, f2_local0[7], 1)
    f2_local0[8] = get_weight_base_on_cooldown(arg1, arg2, 3011, 8, f2_local0[8], 1)
    f2_local0[9] = get_weight_base_on_cooldown(arg1, arg2, 3015, 8, f2_local0[9], 1)
    f2_local0[9] = get_weight_base_on_cooldown(arg1, arg2, 3066, 8, f2_local0[9], 1)
    f2_local0[10] = get_weight_base_on_cooldown(arg1, arg2, 3012, 14, f2_local0[10], 1)
    f2_local0[40] = get_weight_base_on_cooldown(arg1, arg2, 3067, 8, f2_local0[40], 1)
    f2_local0[41] = get_weight_base_on_cooldown(arg1, arg2, 3067, 14, f2_local0[41], 1)
    f2_local0[41] = get_weight_base_on_cooldown(arg1, arg2, 3005, 14, f2_local0[41], 1)
...
Goal.Kengeki_Activate = function (arg0, arg1, arg2)
    local f29_local0 = get_kengeki_sp(arg1)
    ...
    f29_local1[1] = get_weight_base_on_cooldown(arg1, arg2, 3060, 8, f29_local1[1], 1)
    f29_local1[2] = get_weight_base_on_cooldown(arg1, arg2, 3061, 8, f29_local1[2], 1)
    f29_local1[3] = get_weight_base_on_cooldown(arg1, arg2, 3062, 8, f29_local1[3], 1)
    f29_local1[4] = get_weight_base_on_cooldown(arg1, arg2, 3063, 8, f29_local1[4], 1)
    f29_local1[5] = get_weight_base_on_cooldown(arg1, arg2, 3065, 8, f29_local1[5], 1)
    f29_local1[6] = get_weight_base_on_cooldown(arg1, arg2, 3066, 8, f29_local1[6], 1)
    f29_local1[6] = get_weight_base_on_cooldown(arg1, arg2, 3015, 8, f29_local1[6], 1)
    f29_local1[7] = get_weight_base_on_cooldown(arg1, arg2, 3067, 8, f29_local1[7], 1)
    f29_local1[8] = get_weight_base_on_cooldown(arg1, arg2, 3068, 8, f29_local1[8], 1)
    f29_local1[9] = get_weight_base_on_cooldown(arg1, arg2, 3069, 8, f29_local1[9], 1)
    f29_local1[11] = get_weight_base_on_cooldown(arg1, arg2, 3050, 25, f29_local1[11], 0)
    f29_local1[11] = get_weight_base_on_cooldown(arg1, arg2, 3007, 25, f29_local1[11], 0)
