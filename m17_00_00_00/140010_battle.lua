...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    f2_local0[2] = get_weight_base_on_cooldown(arg1, arg2, 3015, 4, f2_local0[2], 1)
    f2_local0[3] = get_weight_base_on_cooldown(arg1, arg2, 3001, 8, f2_local0[3], 1)
    f2_local0[3] = get_weight_base_on_cooldown(arg1, arg2, 3003, 8, f2_local0[3], 1)
    ...
    f2_local0[4] = get_weight_base_on_cooldown(arg1, arg2, 3073, 8, f2_local0[4], 1)
    f2_local0[5] = get_weight_base_on_cooldown(arg1, arg2, 3009, 8, f2_local0[5], 1)
    f2_local0[6] = get_weight_base_on_cooldown(arg1, arg2, 3000, 8, f2_local0[6], 1)
    f2_local0[6] = get_weight_base_on_cooldown(arg1, arg2, 3004, 8, f2_local0[6], 1)
    f2_local0[7] = get_weight_base_on_cooldown(arg1, arg2, 3002, 4, f2_local0[7], 1)
    f2_local0[8] = get_weight_base_on_cooldown(arg1, arg2, 3011, 2, f2_local0[8], 1)
    f2_local0[9] = get_weight_base_on_cooldown(arg1, arg2, 3006, 6, f2_local0[9], 1)
    f2_local0[10] = get_weight_base_on_cooldown(arg1, arg2, 3040, 20, f2_local0[10], 1)
    f2_local0[24] = get_weight_base_on_cooldown(arg1, arg2, 5201, 1, f2_local0[24], 1)
    f2_local0[24] = get_weight_base_on_cooldown(arg1, arg2, 5211, 1, f2_local0[24], 1)
...
Goal.Kengeki_Activate = function (arg0, arg1, arg2, arg3)
    ...
    elseif f32_local0 == SP_PARRY_COUNT_RIGHT then
        if f32_local4 >= 2.5 then
            f32_local1[50] = 100
        else
            f32_local1[4] = 10
    ...
    elseif f32_local0 == SP_PARRY_COUNT_LEFT then
        if f32_local4 >= 2.5 then
            f32_local1[50] = 100
        else
            f32_local1[11] = 100
    ...
    f32_local1[13] = get_weight_base_on_cooldown(arg1, arg2, 3006, 10, f32_local1[13], 1)
