...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    f2_local0[4] = get_weight_base_on_cooldown(arg1, arg2, 3004, 15, f2_local0[4], 1)
    f2_local0[5] = get_weight_base_on_cooldown(arg1, arg2, 3005, 5, f2_local0[5], 1)
    f2_local0[9] = get_weight_base_on_cooldown(arg1, arg2, 3017, 10, f2_local0[9], 1)
    f2_local0[10] = get_weight_base_on_cooldown(arg1, arg2, 3018, 10, f2_local0[10], 1)
    f2_local0[11] = get_weight_base_on_cooldown(arg1, arg2, 3009, 5, f2_local0[11], 1)
    f2_local0[12] = get_weight_base_on_cooldown(arg1, arg2, 3021, 5, f2_local0[12], 1)
    f2_local0[14] = get_weight_base_on_cooldown(arg1, arg2, 3025, 10, f2_local0[14], 1)
    f2_local0[16] = get_weight_base_on_cooldown(arg1, arg2, 3033, 10, f2_local0[16], 1)
    f2_local0[17] = get_weight_base_on_cooldown(arg1, arg2, 3032, 10, f2_local0[17], 1)
    f2_local0[19] = get_weight_base_on_cooldown(arg1, arg2, 3040, 5, f2_local0[19], 1)
...
Goal.Kengeki_Activate = function (arg0, arg1, arg2, arg3)
    local f40_local0 = get_kengeki_sp(arg1)
    ...
    elseif f40_local0 == SP_PARRY_COUNT_RIGHT then
        if f40_local4 >= 2.5 then
            f40_local1[50] = 100
        elseif f40_local4 <= 0.2 then
            f40_local1[50] = 100
    ...
    elseif f40_local0 == SP_PARRY_COUNT_LEFT then
        if f40_local4 >= 2.5 then
            f40_local1[50] = 100
        elseif f40_local4 <= 0.2 then
            f40_local1[50] = 100
