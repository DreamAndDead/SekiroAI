...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    f2_local0[1] = get_weight_base_on_cooldown(arg1, arg2, 3000, 4, f2_local0[1], 1)
    f2_local0[1] = get_weight_base_on_cooldown(arg1, arg2, 3001, 4, f2_local0[1], 1)
    f2_local0[1] = get_weight_base_on_cooldown(arg1, arg2, 4100, 8, f2_local0[1], 1)
    f2_local0[1] = get_weight_base_on_cooldown(arg1, arg2, 4110, 8, f2_local0[1], 1)
    f2_local0[3] = get_weight_base_on_cooldown(arg1, arg2, 3009, 8, f2_local0[3], 1)
    f2_local0[4] = get_weight_base_on_cooldown(arg1, arg2, 3005, 3, f2_local0[4], 1)
    f2_local0[5] = get_weight_base_on_cooldown(arg1, arg2, 3006, 3, f2_local0[5], 1)
    f2_local0[6] = get_weight_base_on_cooldown(arg1, arg2, 3007, 6, f2_local0[6], 1)
    f2_local0[6] = get_weight_base_on_cooldown(arg1, arg2, 3008, 6, f2_local0[6], 1)
    f2_local0[7] = get_weight_base_on_cooldown(arg1, arg2, 3010, 8, f2_local0[7], 1)
    f2_local0[7] = get_weight_base_on_cooldown(arg1, arg2, 3011, 8, f2_local0[7], 1)
    f2_local0[8] = get_weight_base_on_cooldown(arg1, arg2, 3014, 4, f2_local0[8], 1)
    f2_local0[9] = get_weight_base_on_cooldown(arg1, arg2, 3015, 10, f2_local0[9], 1)
    f2_local0[10] = get_weight_base_on_cooldown(arg1, arg2, 3016, 10, f2_local0[10], 1)
    f2_local0[11] = get_weight_base_on_cooldown(arg1, arg2, 3015, 5, f2_local0[11], 1)
    f2_local0[41] = get_weight_base_on_cooldown(arg1, arg2, 3003, 4, f2_local0[41], 1)
    f2_local0[42] = get_weight_base_on_cooldown(arg1, arg2, 3004, 10, f2_local0[42], 1)
