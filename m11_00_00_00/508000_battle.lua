...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    f2_local0[2] = get_weight_base_on_cooldown(arg1, arg2, 3070, 5, f2_local0[2], 1)
    f2_local0[3] = get_weight_base_on_cooldown(arg1, arg2, 3024, 5, f2_local0[3], 1)
    f2_local0[8] = get_weight_base_on_cooldown(arg1, arg2, 3007, 10, f2_local0[8], 1)
    f2_local0[9] = get_weight_base_on_cooldown(arg1, arg2, 3008, 5, f2_local0[9], 1)
    f2_local0[10] = get_weight_base_on_cooldown(arg1, arg2, 3009, 60, f2_local0[10], 1)
    f2_local0[11] = get_weight_base_on_cooldown(arg1, arg2, 3010, 60, f2_local0[11], 1)
    f2_local0[12] = get_weight_base_on_cooldown(arg1, arg2, 3011, 20, f2_local0[12], 1)
    f2_local0[13] = get_weight_base_on_cooldown(arg1, arg2, 3089, 20, f2_local0[13], 1)
    f2_local0[14] = get_weight_base_on_cooldown(arg1, arg2, 3015, 20, f2_local0[14], 1)
    f2_local0[16] = get_weight_base_on_cooldown(arg1, arg2, 3023, 5, f2_local0[16], 1)
    f2_local0[18] = get_weight_base_on_cooldown(arg1, arg2, 3025, 5, f2_local0[18], 1)
    f2_local0[19] = get_weight_base_on_cooldown(arg1, arg2, 3026, 3, f2_local0[19], 1)
    f2_local0[25] = get_weight_base_on_cooldown(arg1, arg2, 5010, 45, f2_local0[25], 1)
    f2_local0[30] = get_weight_base_on_cooldown(arg1, arg2, 5010, 5, f2_local0[30], 1)
    f2_local0[31] = get_weight_base_on_cooldown(arg1, arg2, 3032, 15, f2_local0[31], 1)
    f2_local0[31] = get_weight_base_on_cooldown(arg1, arg2, 3033, 15, f2_local0[31], 1)
    f2_local0[35] = get_weight_base_on_cooldown(arg1, arg2, 3029, 8, f2_local0[35], 1)
    f2_local0[36] = get_weight_base_on_cooldown(arg1, arg2, 3064, 20, f2_local0[36], 1)
    f2_local0[37] = get_weight_base_on_cooldown(arg1, arg2, 3084, f2_local10, f2_local0[37], 1)
    f2_local0[42] = get_weight_base_on_cooldown(arg1, arg2, 3039, 5, f2_local0[42], 1)
    f2_local0[45] = get_weight_base_on_cooldown(arg1, arg2, 3096, 8, f2_local0[45], 1)
    f2_local0[45] = get_weight_base_on_cooldown(arg1, arg2, 3096, 8, f2_local0[45], 1)
    f2_local0[46] = get_weight_base_on_cooldown(arg1, arg2, 3045, 45, f2_local0[46], 1)
...
Goal.Kengeki_Activate = function (arg0, arg1, arg2, arg3)
    local f52_local0 = get_kengeki_sp(arg1)
    ...
    f52_local1[1] = get_weight_base_on_cooldown(arg1, arg2, 3060, 10, f52_local1[1], 1)
    f52_local1[2] = get_weight_base_on_cooldown(arg1, arg2, 3061, 10, f52_local1[2], 1)
    f52_local1[3] = get_weight_base_on_cooldown(arg1, arg2, 3062, 30, f52_local1[3], 1)
    f52_local1[4] = get_weight_base_on_cooldown(arg1, arg2, 3063, 10, f52_local1[4], 1)
    f52_local1[5] = get_weight_base_on_cooldown(arg1, arg2, 3065, 10, f52_local1[5], 1)
    f52_local1[6] = get_weight_base_on_cooldown(arg1, arg2, 3066, 10, f52_local1[6], 1)
    f52_local1[7] = get_weight_base_on_cooldown(arg1, arg2, 3067, 10, f52_local1[7], 1)
    f52_local1[8] = get_weight_base_on_cooldown(arg1, arg2, 3068, 10, f52_local1[8], 1)
    f52_local1[9] = get_weight_base_on_cooldown(arg1, arg2, 3050, 40, f52_local1[9], 1)
    f52_local1[10] = get_weight_base_on_cooldown(arg1, arg2, 3006, 40, f52_local1[10], 1)
    f52_local1[11] = get_weight_base_on_cooldown(arg1, arg2, 3069, 10, f52_local1[11], 1)
    f52_local1[12] = get_weight_base_on_cooldown(arg1, arg2, 3025, 10, f52_local1[12], 1)
    f52_local1[13] = get_weight_base_on_cooldown(arg1, arg2, 3070, 30, f52_local1[13], 1)
    f52_local1[14] = get_weight_base_on_cooldown(arg1, arg2, 3071, 10, f52_local1[14], 1)
    f52_local1[15] = get_weight_base_on_cooldown(arg1, arg2, 3000, 10, f52_local1[15], 1)
    f52_local1[16] = get_weight_base_on_cooldown(arg1, arg2, 3080, 10, f52_local1[16], 1)
    f52_local1[17] = get_weight_base_on_cooldown(arg1, arg2, 3081, 10, f52_local1[17], 1)
    f52_local1[18] = get_weight_base_on_cooldown(arg1, arg2, 3002, 30, f52_local1[18], 1)
    f52_local1[19] = get_weight_base_on_cooldown(arg1, arg2, 3037, 10, f52_local1[19], 1)
    f52_local1[31] = get_weight_base_on_cooldown(arg1, arg2, 3026, 10, f52_local1[31], 1)
    f52_local1[32] = get_weight_base_on_cooldown(arg1, arg2, 3027, 10, f52_local1[32], 1)
    f52_local1[35] = get_weight_base_on_cooldown(arg1, arg2, 3039, 10, f52_local1[35], 1)
    f52_local1[36] = get_weight_base_on_cooldown(arg1, arg2, 3044, 10, f52_local1[36], 1)
