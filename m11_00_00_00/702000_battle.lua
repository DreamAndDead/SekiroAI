...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    f2_local0[2] = get_weight_base_on_cooldown(arg1, arg2, 3005, 15, f2_local0[2], 1)
    f2_local0[3] = get_weight_base_on_cooldown(arg1, arg2, 3007, 20, f2_local0[3], 1)
    f2_local0[4] = get_weight_base_on_cooldown(arg1, arg2, 3008, 15, f2_local0[4], 1)
    f2_local0[5] = get_weight_base_on_cooldown(arg1, arg2, 3010, 20, f2_local0[5], 1)
    f2_local0[6] = get_weight_base_on_cooldown(arg1, arg2, 3015, 20, f2_local0[6], 1)
    f2_local0[7] = get_weight_base_on_cooldown(arg1, arg2, 3018, 10, f2_local0[7], 1)
    f2_local0[8] = get_weight_base_on_cooldown(arg1, arg2, 3019, 25, f2_local0[8], 1)
    f2_local0[9] = get_weight_base_on_cooldown(arg1, arg2, 3023, 20, f2_local0[9], 1)
    f2_local0[10] = get_weight_base_on_cooldown(arg1, arg2, 3025, 20, f2_local0[10], 1)
    f2_local0[10] = get_weight_base_on_cooldown(arg1, arg2, 3026, 10, f2_local0[10], 1)
    f2_local0[11] = get_weight_base_on_cooldown(arg1, arg2, 3032, 20, f2_local0[11], 1)
    f2_local0[12] = get_weight_base_on_cooldown(arg1, arg2, 3036, 40, f2_local0[12], 1)
    f2_local0[13] = get_weight_base_on_cooldown(arg1, arg2, 3037, 15, f2_local0[13], 1)
    f2_local0[14] = get_weight_base_on_cooldown(arg1, arg2, 3038, 50, f2_local0[14], 1)
    f2_local0[14] = get_weight_base_on_cooldown(arg1, arg2, 3042, 50, f2_local0[14], 1)
    f2_local0[15] = get_weight_base_on_cooldown(arg1, arg2, 3040, 10, f2_local0[15], 1)
    f2_local0[16] = get_weight_base_on_cooldown(arg1, arg2, 3041, 10, f2_local0[16], 1)
    f2_local0[17] = get_weight_base_on_cooldown(arg1, arg2, 3047, 15, f2_local0[17], 1)
    f2_local0[18] = get_weight_base_on_cooldown(arg1, arg2, 3045, 10, f2_local0[18], 1)
    f2_local0[19] = get_weight_base_on_cooldown(arg1, arg2, 3046, 30, f2_local0[19], 1)
    f2_local0[22] = get_weight_base_on_cooldown(arg1, arg2, 5202, 10, f2_local0[22], 1)
    f2_local0[22] = get_weight_base_on_cooldown(arg1, arg2, 5203, 10, f2_local0[22], 1)
    f2_local0[24] = get_weight_base_on_cooldown(arg1, arg2, 5201, 20, f2_local0[24], 1)
    f2_local0[24] = get_weight_base_on_cooldown(arg1, arg2, 5211, 10, f2_local0[24], 1)
    f2_local0[24] = get_weight_base_on_cooldown(arg1, arg2, 5202, 5, f2_local0[24], 1)
    f2_local0[24] = get_weight_base_on_cooldown(arg1, arg2, 5203, 5, f2_local0[24], 1)
    f2_local0[29] = get_weight_base_on_cooldown(arg1, arg2, 5201, 10, f2_local0[29], 1)
    f2_local0[29] = get_weight_base_on_cooldown(arg1, arg2, 5211, 20, f2_local0[29], 1)
    f2_local0[29] = get_weight_base_on_cooldown(arg1, arg2, 5202, 5, f2_local0[29], 1)
    f2_local0[29] = get_weight_base_on_cooldown(arg1, arg2, 5203, 5, f2_local0[29], 1)
    f2_local0[33] = get_weight_base_on_cooldown(arg1, arg2, 3036, 25, f2_local0[33], 1)
    f2_local0[34] = get_weight_base_on_cooldown(arg1, arg2, 3048, 20, f2_local0[34], 1)
    f2_local0[35] = get_weight_base_on_cooldown(arg1, arg2, 3049, 15, f2_local0[35], 1)
    f2_local0[36] = get_weight_base_on_cooldown(arg1, arg2, 3044, 30, f2_local0[36], 1)
    f2_local0[36] = get_weight_base_on_cooldown(arg1, arg2, 3036, 30, f2_local0[36], 1)
    f2_local0[37] = get_weight_base_on_cooldown(arg1, arg2, 3038, 30, f2_local0[37], 1)
    f2_local0[37] = get_weight_base_on_cooldown(arg1, arg2, 3042, 30, f2_local0[37], 1)
    f2_local0[40] = get_weight_base_on_cooldown(arg1, arg2, 3019, 5, f2_local0[40], 1)
    f2_local0[41] = get_weight_base_on_cooldown(arg1, arg2, 3032, 5, f2_local0[41], 1)
    f2_local0[42] = get_weight_base_on_cooldown(arg1, arg2, 3037, 5, f2_local0[42], 1)
    f2_local0[43] = get_weight_base_on_cooldown(arg1, arg2, 3010, 5, f2_local0[43], 1)
    f2_local0[44] = get_weight_base_on_cooldown(arg1, arg2, 3046, 5, f2_local0[44], 1)
...
Goal.Interrupt = function (arg0, arg1, arg2)
    ...
    if arg1:IsInterupt(INTERUPT_ActivateSpecialEffect) then
        ...
        elseif arg1:GetSpecialEffectActivateInterruptType(0) == 5036 and f47_local1 <= 6 then
            if arg1:HasSpecialEffectId(TARGET_SELF, 3702001) or arg1:IsFinishTimer(3) == false then
                arg1:Replanning()
            else
                arg2:ClearSubGoal()
