...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    f2_local0[2] = get_weight_base_on_cooldown(arg1, arg2, 3018, 5, f2_local0[2], 1)
    ...
    f2_local0[3] = get_weight_base_on_cooldown(arg1, arg2, 3003, 10, f2_local0[3], 1)
    f2_local0[6] = get_weight_base_on_cooldown(arg1, arg2, 3003, 8, f2_local0[6], 1)
    f2_local0[4] = get_weight_base_on_cooldown(arg1, arg2, 3030, 12, f2_local0[4], 1)
    f2_local0[4] = get_weight_base_on_cooldown(arg1, arg2, 3007, 12, f2_local0[4], 1)
    f2_local0[4] = get_weight_base_on_cooldown(arg1, arg2, 3005, 4, f2_local0[4], 1)
    f2_local0[9] = get_weight_base_on_cooldown(arg1, arg2, 3015, 5, f2_local0[9], 1)
    f2_local0[9] = get_weight_base_on_cooldown(arg1, arg2, 3031, 5, f2_local0[9], 1)
    f2_local0[11] = get_weight_base_on_cooldown(arg1, arg2, 3031, 5, f2_local0[11], 1)
    f2_local0[11] = get_weight_base_on_cooldown(arg1, arg2, 3015, 5, f2_local0[11], 1)
    f2_local0[14] = get_weight_base_on_cooldown(arg1, arg2, 3045, 30, f2_local0[14], 1)
...
Goal.Kengeki_Activate = function (arg0, arg1, arg2, arg3)
    local f36_local0 = get_kengeki_sp(arg1)
    ...
    f36_local1[2] = get_weight_base_on_cooldown(arg1, arg2, 3066, 2, f36_local1[2], 1)
    f36_local1[3] = get_weight_base_on_cooldown(arg1, arg2, 3064, 5, f36_local1[3], 1)
    f36_local1[3] = get_weight_base_on_cooldown(arg1, arg2, 3010, 5, f36_local1[3], 1)
    f36_local1[4] = get_weight_base_on_cooldown(arg1, arg2, 3068, 12, f36_local1[4], 1)
    f36_local1[5] = get_weight_base_on_cooldown(arg1, arg2, 3063, 5, f36_local1[5], 1)
    f36_local1[6] = get_weight_base_on_cooldown(arg1, arg2, 3060, 2, f36_local1[6], 1)
    f36_local1[7] = get_weight_base_on_cooldown(arg1, arg2, 3065, 2, f36_local1[7], 1)
    f36_local1[8] = get_weight_base_on_cooldown(arg1, arg2, 3069, 25, f36_local1[8], 1)
    f36_local1[12] = get_weight_base_on_cooldown(arg1, arg2, 3030, 12, f36_local1[12], 1)
    f36_local1[12] = get_weight_base_on_cooldown(arg1, arg2, 3007, 12, f36_local1[12], 1)
    f36_local1[12] = get_weight_base_on_cooldown(arg1, arg2, 3005, 4, f36_local1[12], 1)
