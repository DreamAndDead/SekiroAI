...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    arg1:AddObserveSpecialEffectAttribute(TARGET_ENE_0, SP_ROUNDHOUSE_KICK_HIT)
    ...
    elseif arg1:GetNumber(7) == 0 and arg1:HasSpecialEffectId(TARGET_SELF, SP_BEHAVIOR_PATTERN_CHANGE_0) then
        f2_local0[14] = 600
    ...
    if (arg1:HasSpecialEffectId(TARGET_ENE_0, SP_PLAYER_DOWN) or arg1:HasSpecialEffectId(TARGET_ENE_0, SP_PC_BREAK)) and f2_local3 <= 5 then
        f2_local0[16] = 100
    end
    ...
    f2_local0[2] = get_weight_base_on_cooldown(arg1, arg2, 3004, 15, f2_local0[2], 1)
    f2_local0[3] = get_weight_base_on_cooldown(arg1, arg2, 3005, 15, f2_local0[3], 1)
    f2_local0[5] = get_weight_base_on_cooldown(arg1, arg2, 3007, 15, f2_local0[5], 1)
    f2_local0[6] = get_weight_base_on_cooldown(arg1, arg2, 3016, 15, f2_local0[6], 1)
    f2_local0[7] = get_weight_base_on_cooldown(arg1, arg2, 3038, 15, f2_local0[7], 1)
    f2_local0[8] = get_weight_base_on_cooldown(arg1, arg2, 3038, 15, f2_local0[8], 1)
    f2_local0[9] = get_weight_base_on_cooldown(arg1, arg2, 3092, 15, f2_local0[9], 1)
    f2_local0[10] = get_weight_base_on_cooldown(arg1, arg2, 3006, 15, f2_local0[10], 1)
    f2_local0[11] = get_weight_base_on_cooldown(arg1, arg2, 3037, 15, f2_local0[11], 1)
    f2_local0[13] = get_weight_base_on_cooldown(arg1, arg2, 3031, 15, f2_local0[13], 1)
    f2_local0[14] = get_weight_base_on_cooldown(arg1, arg2, 3026, 15, f2_local0[14], 1)
    f2_local0[15] = get_weight_base_on_cooldown(arg1, arg2, 3014, 15, f2_local0[15], 1)
    f2_local0[17] = get_weight_base_on_cooldown(arg1, arg2, 3014, 15, f2_local0[17], 1)
    f2_local0[18] = get_weight_base_on_cooldown(arg1, arg2, 3014, 15, f2_local0[18], 1)
    f2_local0[30] = get_weight_base_on_cooldown(arg1, arg2, 3009, 15, f2_local0[30], 1)
    f2_local0[31] = get_weight_base_on_cooldown(arg1, arg2, 3045, 15, f2_local0[31], 1)
    f2_local0[32] = get_weight_base_on_cooldown(arg1, arg2, 3006, 15, f2_local0[32], 1)
    f2_local0[34] = get_weight_base_on_cooldown(arg1, arg2, 3007, 15, f2_local0[34], 1)
    f2_local0[48] = get_weight_base_on_cooldown(arg1, arg2, 3013, 5, f2_local0[48], 1)
    f2_local0[49] = get_weight_base_on_cooldown(arg1, arg2, 3018, 5, f2_local0[49], 1)
...
Goal.Act24 = function (arg0, arg1, arg2)
    ...
    if f25_local4 <= 0.7 and arg0:HasSpecialEffectId(TARGET_SELF, SP_BEHAVIOR_PATTERN_CHANGE_0) then
...
Goal.Interrupt = function (arg0, arg1, arg2)
    ...
    if arg1:IsInterupt(INTERUPT_ActivateSpecialEffect) then
        if f41_local0 == SP_SHINOBI_JUDGMENT then
            arg1:SetNumber(0, 0)
            return true
        elseif f41_local0 == SP_AI_INT_JUDGMENT_ADDITION_PLAYED and arg1:HasSpecialEffectId(TARGET_SELF, SP_AI_INT_JUDGMENT_PARRIED_AND_STRONG_ATTACK) then
            arg2:ClearSubGoal()
        ...
        elseif f41_local0 == SP_ROUNDHOUSE_KICK_HIT then
            if arg1:HasSpecialEffectId(TARGET_ENE_0, 105025) or arg1:HasSpecialEffectId(TARGET_ENE_0, 100320) then
                arg2:ClearSubGoal()
                arg2:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3026, TARGET_ENE_0, 999, 0)
            elseif f41_local3 <= 50 and arg1:HasSpecialEffectId(TARGET_SELF, SP_BEHAVIOR_PATTERN_CHANGE_0) then
                arg2:ClearSubGoal()
        ...
        elseif f41_local0 == SP_ENEMY_AI_REFERENCE_DEDICATED_RESPONSE_IAI_STANCE then
            arg1:Replanning()
            return true
        end
    end
    if Interupt_Use_Item(arg1, 8, 5) then
        if arg1:HasSpecialEffectId(TARGET_SELF, SP_BEHAVIOR_PATTERN_CHANGE_1) and f41_local4 >= 2 then
...
Goal.Parry = function (arg0, arg1, arg2, arg3)
    ...
    local f42_local5 = arg0:HasSpecialEffectId(TARGET_ENE_0, SP_PUSH)
    local f42_local6 = arg0:HasSpecialEffectId(TARGET_ENE_0, SP_CONTINUOUS_ATTACK)
    local f42_local7 = 2
...
Goal.Damaged = function (arg0, arg1, arg2)
    ...
    if f43_local3 <= 15 then
        ...
        return true
    elseif f43_local3 <= 30 and arg0:HasSpecialEffectId(TARGET_SELF, SP_BEHAVIOR_PATTERN_CHANGE_0) then
        arg1:ClearSubGoal()
...
Goal.Kengeki_Activate = function (arg0, arg1, arg2, arg3)
    local f45_local0 = get_kengeki_sp(arg1)
    ...
    elseif f45_local0 == SP_PARRY_COUNT_RIGHT then
        f45_local1[2] = 100
        f45_local1[17] = 100
        f45_local1[41] = 50
        f45_local1[31] = 50
    elseif f45_local0 == SP_PARRY_COUNT_LEFT then
        f45_local1[2] = 100
        f45_local1[10] = 50
        f45_local1[31] = 50
        f45_local1[41] = 50
    ...
    f45_local1[1] = get_weight_base_on_cooldown(arg1, arg2, 3050, 8, f45_local1[1], 1)
    f45_local1[2] = get_weight_base_on_cooldown(arg1, arg2, 5201, 10, f45_local1[2], 1)
    f45_local1[3] = get_weight_base_on_cooldown(arg1, arg2, 3009, 10, f45_local1[3], 1)
    f45_local1[4] = get_weight_base_on_cooldown(arg1, arg2, 3055, 8, f45_local1[4], 1)
    f45_local1[7] = get_weight_base_on_cooldown(arg1, arg2, 3060, 8, f45_local1[7], 1)
    f45_local1[9] = get_weight_base_on_cooldown(arg1, arg2, 3018, 8, f45_local1[9], 1)
    f45_local1[10] = get_weight_base_on_cooldown(arg1, arg2, 3065, 8, f45_local1[10], 1)
    f45_local1[11] = get_weight_base_on_cooldown(arg1, arg2, 3070, 8, f45_local1[11], 1)
    f45_local1[12] = get_weight_base_on_cooldown(arg1, arg2, 3018, 8, f45_local1[12], 1)
    f45_local1[13] = get_weight_base_on_cooldown(arg1, arg2, 3070, 8, f45_local1[13], 1)
    f45_local1[14] = get_weight_base_on_cooldown(arg1, arg2, 3076, 8, f45_local1[14], 1)
    f45_local1[15] = get_weight_base_on_cooldown(arg1, arg2, 3031, 15, f45_local1[15], 1)
    f45_local1[16] = get_weight_base_on_cooldown(arg1, arg2, 3070, 8, f45_local1[16], 1)
    f45_local1[17] = get_weight_base_on_cooldown(arg1, arg2, 3071, 8, f45_local1[17], 1)
    f45_local1[18] = get_weight_base_on_cooldown(arg1, arg2, 3004, 8, f45_local1[18], 1)
    f45_local1[20] = get_weight_base_on_cooldown(arg1, arg2, 5202, 15, f45_local1[20], 1)
    f45_local1[22] = get_weight_base_on_cooldown(arg1, arg2, 3070, 8, f45_local1[22], 1)
    f45_local1[30] = get_weight_base_on_cooldown(arg1, arg2, 3063, 15, f45_local1[30], 1)
    f45_local1[31] = get_weight_base_on_cooldown(arg1, arg2, 3068, 15, f45_local1[31], 1)
    f45_local1[32] = get_weight_base_on_cooldown(arg1, arg2, 3018, 15, f45_local1[32], 1)
    f45_local1[33] = get_weight_base_on_cooldown(arg1, arg2, 3007, 15, f45_local1[33], 1)
    f45_local1[34] = get_weight_base_on_cooldown(arg1, arg2, 3037, 15, f45_local1[34], 1)
    f45_local1[35] = get_weight_base_on_cooldown(arg1, arg2, 3016, 8, f45_local1[35], 1)
    f45_local1[37] = get_weight_base_on_cooldown(arg1, arg2, 3030, 8, f45_local1[37], 1)
    f45_local1[38] = get_weight_base_on_cooldown(arg1, arg2, 3030, 8, f45_local1[38], 1)
    f45_local1[39] = get_weight_base_on_cooldown(arg1, arg2, 3034, 15, f45_local1[39], 1)
    f45_local1[40] = get_weight_base_on_cooldown(arg1, arg2, 3040, 15, f45_local1[40], 1)
    f45_local1[41] = get_weight_base_on_cooldown(arg1, arg2, 3030, 15, f45_local1[41], 1)
    f45_local1[42] = get_weight_base_on_cooldown(arg1, arg2, 3030, 15, f45_local1[42], 1)
    f45_local1[43] = get_weight_base_on_cooldown(arg1, arg2, 3062, 15, f45_local1[43], 1)
    f45_local1[44] = get_weight_base_on_cooldown(arg1, arg2, 3067, 15, f45_local1[44], 1)
    f45_local1[45] = get_weight_base_on_cooldown(arg1, arg2, 3032, 15, f45_local1[45], 1)
...
Goal.Kengeki02 = function (arg0, arg1, arg2)
    ...
    arg0:SetNumber(2, 1)
    if f47_local0 <= 0.7 and arg0:HasSpecialEffectId(TARGET_SELF, SP_BEHAVIOR_PATTERN_CHANGE_0) then
