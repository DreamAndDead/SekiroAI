...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    if arg1:HasSpecialEffectId(TARGET_SELF, 3506030) or arg1:HasSpecialEffectId(TARGET_SELF, 3506080) then
        f2_local0[26] = 100
    ...
    elseif arg1:IsFinishTimer(1) and arg1:HasSpecialEffectId(TARGET_SELF, SP_BEHAVIOR_PATTERN_CHANGE_1) and arg1:HasSpecialEffectId(TARGET_SELF, 5034) == false and f2_local5 <= 12 and f2_local5 >= 3 then
        f2_local0[20] = 100
...
Goal.Parry = function (arg0, arg1, arg2, arg3)
    ...
    local f43_local5 = arg0:HasSpecialEffectId(TARGET_ENE_0, SP_PUSH)
    local f43_local6 = arg0:HasSpecialEffectId(TARGET_ENE_0, SP_CONTINUOUS_ATTACK)
...
Goal.Kengeki_Activate = function (arg0, arg1, arg2, arg3)
    ...
    f45_local1[2] = get_weight_base_on_cooldown(arg1, arg2, 3066, 2, f45_local1[2], 1)
    f45_local1[3] = get_weight_base_on_cooldown(arg1, arg2, 3064, 5, f45_local1[3], 1)
    f45_local1[4] = get_weight_base_on_cooldown(arg1, arg2, 3068, 5, f45_local1[4], 1)
    f45_local1[6] = get_weight_base_on_cooldown(arg1, arg2, 3060, 2, f45_local1[6], 1)
    f45_local1[7] = get_weight_base_on_cooldown(arg1, arg2, 3065, 2, f45_local1[7], 1)
    f45_local1[12] = get_weight_base_on_cooldown(arg1, arg2, 3005, 4, f45_local1[12], 1)
    f45_local1[12] = get_weight_base_on_cooldown(arg1, arg2, 3006, 8, f45_local1[12], 1)
    f45_local1[12] = get_weight_base_on_cooldown(arg1, arg2, 3007, 8, f45_local1[12], 1)
    f45_local1[13] = get_weight_base_on_cooldown(arg1, arg2, 3024, 5, f45_local1[13], 1)
