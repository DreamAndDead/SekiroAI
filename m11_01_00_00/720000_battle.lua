...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    if arg1:HasSpecialEffectId(TARGET_SELF, SP_AI_STATE_NORMAL) then
        f2_local0[26] = 100
    elseif arg1:HasSpecialEffectId(TARGET_SELF, SP_AI_STATE_DISCOVERY_OR_COMBAT) then
        if f2_local6 >= 4 then
            if arg1:HasSpecialEffectId(TARGET_LOCALPLAYER, 109221) or arg1:HasSpecialEffectId(TARGET_LOCALPLAYER, 109220) then
                f2_local0[3] = 100
            else
                f2_local0[2] = 100
            end
