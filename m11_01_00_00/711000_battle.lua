...
Goal.Kengeki_Activate = function (arg0, arg1, arg2, arg3)
    local f43_local0 = get_kengeki_sp(arg1)
    ...
    elseif f43_local0 == SP_PARRY_COUNT_RIGHT then
        f43_local1[17] = 100
        f43_local1[38] = 50
        f43_local1[31] = 50
    elseif f43_local0 == SP_PARRY_COUNT_LEFT then
        f43_local1[31] = 50
        f43_local1[38] = 50
    ...
    f43_local1[1] = get_weight_base_on_cooldown(arg1, arg2, 3050, 8, f43_local1[1], 1)
    f43_local1[2] = get_weight_base_on_cooldown(arg1, arg2, 5201, 10, f43_local1[2], 1)
    f43_local1[4] = get_weight_base_on_cooldown(arg1, arg2, 3055, 8, f43_local1[4], 1)
    f43_local1[7] = get_weight_base_on_cooldown(arg1, arg2, 3060, 8, f43_local1[7], 1)
    f43_local1[9] = get_weight_base_on_cooldown(arg1, arg2, 3018, 8, f43_local1[9], 1)
    f43_local1[10] = get_weight_base_on_cooldown(arg1, arg2, 3065, 8, f43_local1[10], 1)
    f43_local1[13] = get_weight_base_on_cooldown(arg1, arg2, 3075, 8, f43_local1[13], 1)
    f43_local1[14] = get_weight_base_on_cooldown(arg1, arg2, 3076, 8, f43_local1[14], 1)
    f43_local1[15] = get_weight_base_on_cooldown(arg1, arg2, 3031, 15, f43_local1[15], 1)
    f43_local1[17] = get_weight_base_on_cooldown(arg1, arg2, 3071, 8, f43_local1[17], 1)
    f43_local1[18] = get_weight_base_on_cooldown(arg1, arg2, 3004, 8, f43_local1[18], 1)
    f43_local1[20] = get_weight_base_on_cooldown(arg1, arg2, 5202, 15, f43_local1[20], 1)
    f43_local1[22] = get_weight_base_on_cooldown(arg1, arg2, 3087, 20, f43_local1[22], 1)
    f43_local1[30] = get_weight_base_on_cooldown(arg1, arg2, 3063, 15, f43_local1[30], 1)
    f43_local1[31] = get_weight_base_on_cooldown(arg1, arg2, 3068, 15, f43_local1[31], 1)
    f43_local1[32] = get_weight_base_on_cooldown(arg1, arg2, 3018, 15, f43_local1[32], 1)
    f43_local1[33] = get_weight_base_on_cooldown(arg1, arg2, 3007, 15, f43_local1[33], 1)
    f43_local1[34] = get_weight_base_on_cooldown(arg1, arg2, 3037, 15, f43_local1[34], 1)
    f43_local1[35] = get_weight_base_on_cooldown(arg1, arg2, 3016, 8, f43_local1[35], 1)
    f43_local1[38] = get_weight_base_on_cooldown(arg1, arg2, 3030, 8, f43_local1[38], 1)
    f43_local1[39] = get_weight_base_on_cooldown(arg1, arg2, 3034, 15, f43_local1[39], 1)
    f43_local1[40] = get_weight_base_on_cooldown(arg1, arg2, 3028, 15, f43_local1[40], 1)
    f43_local1[41] = get_weight_base_on_cooldown(arg1, arg2, 3020, 15, f43_local1[41], 1)
    f43_local1[43] = get_weight_base_on_cooldown(arg1, arg2, 3062, 15, f43_local1[43], 1)
    f43_local1[44] = get_weight_base_on_cooldown(arg1, arg2, 3067, 15, f43_local1[44], 1)
    f43_local1[45] = get_weight_base_on_cooldown(arg1, arg2, 3032, 15, f43_local1[45], 1)
    f43_local1[46] = get_weight_base_on_cooldown(arg1, arg2, 3039, 15, f43_local1[46], 1)
