...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    f2_local0[2] = get_weight_base_on_cooldown(arg1, arg2, 3006, 15, f2_local0[2], 1)
    f2_local0[2] = get_weight_base_on_cooldown(arg1, arg2, 3007, 15, f2_local0[2], 1)
    f2_local0[3] = get_weight_base_on_cooldown(arg1, arg2, 3037, 15, f2_local0[3], 1)
    f2_local0[4] = get_weight_base_on_cooldown(arg1, arg2, 3083, 15, f2_local0[4], 1)
    f2_local0[5] = get_weight_base_on_cooldown(arg1, arg2, 3007, 8, f2_local0[5], 1)
    f2_local0[6] = get_weight_base_on_cooldown(arg1, arg2, 3004, 15, f2_local0[6], 1)
    f2_local0[7] = get_weight_base_on_cooldown(arg1, arg2, 3029, 15, f2_local0[7], 1)
    f2_local0[8] = get_weight_base_on_cooldown(arg1, arg2, 3027, 8, f2_local0[8], 1)
    f2_local0[9] = get_weight_base_on_cooldown(arg1, arg2, 3004, 15, f2_local0[9], 1)
    f2_local0[10] = get_weight_base_on_cooldown(arg1, arg2, 3013, 15, f2_local0[10], 1)
    f2_local0[10] = get_weight_base_on_cooldown(arg1, arg2, 3071, 15, f2_local0[10], 1)
    f2_local0[12] = get_weight_base_on_cooldown(arg1, arg2, 3029, 15, f2_local0[12], 1)
    f2_local0[13] = get_weight_base_on_cooldown(arg1, arg2, 3005, 15, f2_local0[13], 1)
    f2_local0[14] = get_weight_base_on_cooldown(arg1, arg2, 3044, 120, f2_local0[14], 1)
    f2_local0[15] = get_weight_base_on_cooldown(arg1, arg2, 3045, 120, f2_local0[15], 1)
    f2_local0[16] = get_weight_base_on_cooldown(arg1, arg2, 3000, 15, f2_local0[16], 1)
    f2_local0[23] = get_weight_base_on_cooldown(arg1, arg2, 405002, 15, f2_local0[23], 1)
    f2_local0[23] = get_weight_base_on_cooldown(arg1, arg2, 405003, 15, f2_local0[23], 1)
    f2_local0[31] = get_weight_base_on_cooldown(arg1, arg2, 405012, 20, f2_local0[31], 1)
    f2_local0[32] = get_weight_base_on_cooldown(arg1, arg2, 405013, 30, f2_local0[32], 1)
    f2_local0[41] = get_weight_base_on_cooldown(arg1, arg2, 3104, 45, f2_local0[41], 1)
    f2_local0[42] = get_weight_base_on_cooldown(arg1, arg2, 3032, 30, f2_local0[42], 1)
    f2_local0[44] = get_weight_base_on_cooldown(arg1, arg2, 3035, 15, f2_local0[44], 1)
    f2_local0[45] = get_weight_base_on_cooldown(arg1, arg2, 3030, 30, f2_local0[45], 1)
    f2_local0[46] = get_weight_base_on_cooldown(arg1, arg2, 3050, 10, f2_local0[46], 1)
    f2_local0[48] = get_weight_base_on_cooldown(arg1, arg2, 3078, 10, f2_local0[48], 1)
    f2_local0[49] = get_weight_base_on_cooldown(arg1, arg2, 3080, 20, f2_local0[49], 0)
...
Goal.Parry = function (arg0, arg1, arg2, arg3)
    ...
    if arg0:HasSpecialEffectId(TARGET_ENE_0, 110501) or arg0:HasSpecialEffectId(TARGET_ENE_0, 110500) then
        return false
    end
...
Goal.Kengeki_Activate = function (arg0, arg1, arg2, arg3)
    local f50_local0 = get_kengeki_sp(arg1)
    ...
    if f50_local5 <= 0 then
        ...
        elseif f50_local0 == SP_PARRY_COUNT_RIGHT then
            if arg1:IsFinishTimer(6) == false then
                arg2:ClearSubGoal()
    ...
    f50_local1[1] = get_weight_base_on_cooldown(arg1, arg2, 3071, 8, f50_local1[1], 1)
    f50_local1[2] = get_weight_base_on_cooldown(arg1, arg2, 3060, 8, f50_local1[2], 1)
    f50_local1[3] = get_weight_base_on_cooldown(arg1, arg2, 3065, 8, f50_local1[3], 1)
    f50_local1[4] = get_weight_base_on_cooldown(arg1, arg2, 3007, 8, f50_local1[4], 1)
    f50_local1[5] = get_weight_base_on_cooldown(arg1, arg2, 3009, 8, f50_local1[5], 1)
    f50_local1[6] = get_weight_base_on_cooldown(arg1, arg2, 3037, 8, f50_local1[6], 1)
    f50_local1[7] = get_weight_base_on_cooldown(arg1, arg2, 3026, 8, f50_local1[7], 1)
    f50_local1[8] = get_weight_base_on_cooldown(arg1, arg2, 5201, 15, f50_local1[8], 1)
    f50_local1[9] = get_weight_base_on_cooldown(arg1, arg2, 3071, 15, f50_local1[9], 1)
    f50_local1[10] = get_weight_base_on_cooldown(arg1, arg2, 3084, 20, f50_local1[10], 1)
    f50_local1[11] = get_weight_base_on_cooldown(arg1, arg2, 3003, 15, f50_local1[11], 1)
    f50_local1[12] = get_weight_base_on_cooldown(arg1, arg2, 3005, 8, f50_local1[12], 1)
    f50_local1[13] = get_weight_base_on_cooldown(arg1, arg2, 3016, 8, f50_local1[13], 1)
    f50_local1[14] = get_weight_base_on_cooldown(arg1, arg2, 3077, 8, f50_local1[14], 1)
    f50_local1[15] = get_weight_base_on_cooldown(arg1, arg2, 3037, 15, f50_local1[15], 1)
    f50_local1[17] = get_weight_base_on_cooldown(arg1, arg2, 3009, 8, f50_local1[17], 1)
    f50_local1[20] = get_weight_base_on_cooldown(arg1, arg2, 5201, 15, f50_local1[20], 1)
    f50_local1[21] = get_weight_base_on_cooldown(arg1, arg2, 3050, 15, f50_local1[21], 1)
    f50_local1[22] = get_weight_base_on_cooldown(arg1, arg2, 3044, 15, f50_local1[22], 1)
    f50_local1[31] = get_weight_base_on_cooldown(arg1, arg2, 3072, 15, f50_local1[22], 1)
    f50_local1[42] = get_weight_base_on_cooldown(arg1, arg2, 3032, 30, f50_local1[42], 1)
    f50_local1[44] = get_weight_base_on_cooldown(arg1, arg2, 3035, 15, f50_local1[44], 1)
    f50_local1[45] = get_weight_base_on_cooldown(arg1, arg2, 3030, 30, f50_local1[45], 1)
    f50_local1[46] = get_weight_base_on_cooldown(arg1, arg2, 3050, 15, f50_local1[46], 1)
