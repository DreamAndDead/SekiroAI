...
Goal.Activate = function(arg0, arg1, arg2)
    ...
    if f1_local0 >= arg1:GetStringIndexedNumber("DistMin_AAA") and arg1:GetStringIndexedNumber("DistMax_AAA") >= f1_local0 then
        local f1_local1 = arg1:IsInsideTarget(TARGET_ENE_0, arg1:GetStringIndexedNumber("BaseDir_AAA"),
            arg1:GetStringIndexedNumber("Angle_AAA"))
        if f1_local1 == true then
            ...
            local f1_local5 = arg1:GetStringIndexedNumber("Odds_NoAct_AAA") +
            arg1:GetStringIndexedNumber("Odds_BackAndSide_AAA") + arg1:GetStringIndexedNumber("Odds_Back_AAA") +
            arg1:GetStringIndexedNumber("Odds_Backstep_AAA") + arg1:GetStringIndexedNumber("Odds_Sidestep_AAA") +
            arg1:GetStringIndexedNumber("Odds_BitWait_AAA") + arg1:GetStringIndexedNumber("Odds_BsAndSide_AAA") +
            arg1:GetStringIndexedNumber("Odds_BsAndSs_AAA")
            ...
            elseif f1_local6 < f1_local14 and f1_local14 <= f1_local7 then
                local f1_local15 = arg2:AddSubGoal(GOAL_COMMON_LeaveTarget,
                    arg1:GetStringIndexedNumber("BackAndSide_BackLife_AAA"), TARGET_ENE_0,
                    arg1:GetStringIndexedNumber("BackAndSide_BackDist_AAA"), TARGET_ENE_0, true, f1_local1)
                f1_local15 = f1_local15:SetTargetRange(30, arg1:GetStringIndexedNumber("DistMin_Inter_AAA"),
                    arg1:GetStringIndexedNumber("DistMax_Inter_AAA"))
                f1_local15:SetTargetAngle(30, arg1:GetStringIndexedNumber("BaseAng_Inter_AAA"),
                    arg1:GetStringIndexedNumber("Ang_Inter_AAA"))
                f1_local15 = arg2:AddSubGoal(GOAL_COMMON_SidewayMove,
                    arg1:GetStringIndexedNumber("BackAndSide_SideLife_AAA"), TARGET_ENE_0, f1_local2,
                    arg1:GetStringIndexedNumber("BackAndSide_SideDir_AAA"), true, true, f1_local1)
                f1_local15 = f1_local15:SetTargetRange(30, arg1:GetStringIndexedNumber("DistMin_Inter_AAA"),
                    arg1:GetStringIndexedNumber("DistMax_Inter_AAA"))
                f1_local15:SetTargetAngle(30, arg1:GetStringIndexedNumber("BaseAng_Inter_AAA"),
                    arg1:GetStringIndexedNumber("Ang_Inter_AAA"))
            elseif f1_local7 < f1_local14 and f1_local14 <= f1_local8 then
                arg2:AddSubGoal(GOAL_COMMON_LeaveTarget, arg1:GetStringIndexedNumber("BackLife_AAA"), TARGET_ENE_0,
                    arg1:GetStringIndexedNumber("BackDist_AAA"), TARGET_ENE_0, true, f1_local1)
            elseif f1_local8 < f1_local14 and f1_local14 <= f1_local9 then
                arg2:AddSubGoal(GOAL_COMMON_SpinStep, 5, 6001, TARGET_ENE_0, 0, AI_DIR_TYPE_B,
                    arg1:GetStringIndexedNumber("Dist_BackStep"))
            ...
            elseif f1_local11 < f1_local14 and f1_local14 <= f1_local12 then
                arg2:AddSubGoal(GOAL_COMMON_SpinStep, 5, 6001, TARGET_ENE_0, 0, AI_DIR_TYPE_B,
                    arg1:GetStringIndexedNumber("Dist_BackStep"))
                local f1_local15 = arg2:AddSubGoal(GOAL_COMMON_SidewayMove,
                    arg1:GetStringIndexedNumber("BsAndSide_SideLife_AAA"), TARGET_ENE_0, f1_local2,
                    arg1:GetStringIndexedNumber("BsAndSide_SideDir_AAA"), true, true, f1_local1)
                f1_local15 = f1_local15:SetTargetRange(30, arg1:GetStringIndexedNumber("DistMin_Inter_AAA"),
                    arg1:GetStringIndexedNumber("DistMax_Inter_AAA"))
                f1_local15:SetTargetAngle(30, arg1:GetStringIndexedNumber("BaseAng_Inter_AAA"),
                    arg1:GetStringIndexedNumber("Ang_Inter_AAA"))
