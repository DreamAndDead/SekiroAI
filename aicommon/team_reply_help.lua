function TeamReplyHelp_Activate(arg0, arg1)
    ...
    if f1_local12 == f1_local4 then
        ...
        if f1_local13 > 3 then
            arg1:AddSubGoal(GOAL_COMMON_MoveToSomewhere, arg1:GetLife(), TARGET_FRI_0, AI_DIR_TYPE_CENTER, 2.5,
                TARGET_SELF, true)
        else
    ...
    elseif f1_local12 == f1_local10 then
        ...
        if f1_local13 > 2 then
            arg1:AddSubGoal(GOAL_COMMON_MoveToSomewhere, arg1:GetLife(), POINT_AI_FIXED_POS, AI_DIR_TYPE_CENTER, 2.5,
                TARGET_SELF, false)
        else
