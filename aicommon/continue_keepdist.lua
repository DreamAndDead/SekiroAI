...
Goal.ContinueKeepDist = function(arg0, arg1, arg2)
    ...
    if f3_local2 <= f3_local6 then
        ...
        if f3_local2 <= f3_local0 then
            local f3_local8 = arg2:AddSubGoal(GOAL_COMMON_ApproachTarget, arg2:GetLife(), TARGET_ENE_0,
                (f3_local2 + f3_local1) / 2, TARGET_SELF, false, f3_local7)
            f3_local8:SetFailedEndOption(AI_GOAL_FAILED_END_OPT__PARENT_NEXT_SUB_GOAL)
        else
            local f3_local8 = arg2:AddSubGoal(GOAL_COMMON_ApproachTarget, arg2:GetLife(), TARGET_ENE_0,
                (f3_local2 + f3_local1) / 2, TARGET_SELF, true, f3_local7)
            f3_local8:SetFailedEndOption(AI_GOAL_FAILED_END_OPT__PARENT_NEXT_SUB_GOAL)
        end
    elseif f3_local6 <= f3_local1 then
        ...
        local f3_local8 = arg2:AddSubGoal(GOAL_COMMON_LeaveTarget, arg2:GetLife(), TARGET_ENE_0,
            (f3_local2 + f3_local1) / 2, TARGET_ENE_0, true, f3_local7)
        f3_local8:SetFailedEndOption(AI_GOAL_FAILED_END_OPT__PARENT_NEXT_SUB_GOAL)
    end
    arg2:AddSubGoal(GOAL_COMMON_SidewayMove, arg1:GetRandam_Float(3, 5), TARGET_ENE_0, arg1:GetRandam_Int(0, 1),
        arg1:GetRandam_Int(30, 45), true, true, Guard)
end
