...
-- pc 对自己进行忍杀判定，红点出现，等待最后一击
SP_SHINOBI_JUDGMENT = 3710020

-- 加成命中？
SP_AI_INT_JUDGMENT_ADDITION_PLAYED = 3710030
-- 被弹开，直接连接攻击
SP_AI_INT_JUDGMENT_PARRIED_AND_STRONG_ATTACK = 3710032

-- 被 pc 的回旋踢命中
SP_ROUNDHOUSE_KICK_HIT = 3710050
-- 通用逻辑判断效果 10
SP_LOGIC_JUDGMENT_10 = 5029
-- 通用逻辑判断效果 12
SP_LOGIC_JUDGMENT_12 = 5031

-- pc 倒地状态
SP_PLAYER_DOWN = 109031
-- 死亡判定
SP_DEAD = 110060
-- 复活术 装死效果
SP_PRETEND_DEAD = 110010
-- 行为模式改变标识 0，标识武器的转变，剑 -> 弓 之类
SP_BEHAVIOR_PATTERN_CHANGE_0 = 200050
-- 行为模式改变标识 1，标识武器的转变，剑 -> 弓 之类
SP_BEHAVIOR_PATTERN_CHANGE_1 = 200051

SP_RETURN_FROM_FALLING = 120
-- 敌人 AI 参照，pc 正在忍杀其它人
SP_ENEMY_AI_REFERENCE_SHINOBI = 110030
-- 敌人 AI 参照，pc 正在冲刺移动
SP_ENEMY_AI_REFERENCE_DASHING = 109900
-- 对 pc 居合斩姿态的特殊响应
SP_ENEMY_AI_REFERENCE_DEDICATED_RESPONSE_IAI_STANCE = 110620
-- 对 pc 居合斩的特殊响应
SP_ENEMY_AI_REFERENCE_DEDICATED_RESPONSE_IAI_SLASHING = 110621
-- 复活后 1？一阶段？
