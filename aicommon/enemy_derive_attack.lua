...
Goal.Activate = function(arg0, arg1, arg2)
    ...
    arg2:AddSubGoal(GOAL_EnemyDeriveAttackMain, arg2:GetLife(), arg2:GetParam(0), arg2:GetParam(1), arg2:GetParam(2),
        arg2:GetParam(3), 1, f1_local0)
end
    ...
    if arg2:GetNumber(2) == 1 then
        if arg2:GetNumber(0) == 0 and arg1:IsEnableComboAttack() then
            ...
            if f3_local0 ~= 9999999 and arg1:GetAIAttackParam(f3_local0, AI_ATTACK_PARAM_TYPE__IS_FIRST_ATTACK) == 0 then
                arg2:AddSubGoal(GOAL_EnemyDeriveAttackMain, arg2:GetLife(), arg2:GetParam(0), f3_local0, arg2:GetParam(2),
                    arg2:GetParam(3) - 1, arg2:GetParam(4) + 1)
            else
                arg2:AddSubGoal(GOAL_EnemyDeriveAttackSub, arg2:GetLife(), arg2:GetParam(0), arg2:GetParam(1),
                    arg2:GetParam(2), arg2:GetParam(3) - 1, arg2:GetParam(4) + 1)
            end
        end
...
Goal.Activate = function(arg0, arg1, arg2)
    ...
    if f4_local0 ~= 9999999 then
        arg2:AddSubGoal(GOAL_EnemyDeriveAttackMain, arg2:GetLife(), arg2:GetParam(0), f4_local0, arg2:GetParam(2),
