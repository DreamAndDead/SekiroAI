...
function RouteMove_Activate(arg0, arg1)
    ...
    arg1:AddSubGoal(GOAL_COMMON_MoveToSomewhereSmooth, f1_local0, POINT_MOVE_POINT, AI_DIR_TYPE_CENTER, f1_local3,
        TARGET_SELF, f1_local4)
    arg1:AddSubGoal(GOAL_COMMON_MoveToSomewhereSmooth, f1_local0, POINT_MOVE_POINT, AI_DIR_TYPE_CENTER, f1_local3,
        TARGET_SELF, f1_local4)
end
...
function RouteMove_Update(arg0, arg1)
    if arg1:GetSubGoalNum() <= 1 then
        ...
        arg1:AddSubGoal(GOAL_COMMON_MoveToSomewhereSmooth, f2_local0, POINT_MOVE_POINT, AI_DIR_TYPE_CENTER, f2_local2,
            TARGET_SELF, f2_local3)
    end
