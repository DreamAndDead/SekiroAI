...
function ApproachTargetLifeSuccess_Activate(arg0, arg1)
    arg1:AddSubGoal(GOAL_COMMON_ApproachTarget, -1, arg1:GetParam(0), arg1:GetParam(1), arg1:GetParam(2),
        arg1:GetParam(3), arg1:GetParam(4), arg1:GetParam(5), arg1:GetParam(6))
end
