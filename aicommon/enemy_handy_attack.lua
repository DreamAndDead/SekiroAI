...
Goal.Activate = function(arg0, arg1, arg2)
    ...
    if f1_local0 == 7008 then
        arg2:AddSubGoal(GOAL_EnemyStepFront, arg2:GetLife(), f1_local3,
            arg1:GetAIAttackParam(7008, AI_ATTACK_PARAM_TYPE__MIN_ARRIVE_DISTANCE))
    elseif f1_local0 == 7003 then
        arg2:AddSubGoal(GOAL_EnemyStepLR, arg2:GetLife(), f1_local3,
            arg1:GetAIAttackParam(7003, AI_ATTACK_PARAM_TYPE__MIN_ARRIVE_DISTANCE))
    elseif f1_local0 == 7004 then
        arg2:AddSubGoal(GOAL_EnemyStepBack, arg2:GetLife(), f1_local3,
            arg1:GetAIAttackParam(7004, AI_ATTACK_PARAM_TYPE__MIN_ARRIVE_DISTANCE))
    ...
    if arg2:GetNumber(1) == 1 then
        ...
        if arg1:IsEnableComboAttack() then
            ...
            if arg1:IsHitAttack() then
                ...
                arg2:AddSubGoal(GOAL_EnemyHandyAttack, arg2:GetLife(), f2_local1, arg2:GetParam(1), arg2:GetParam(3),
                    arg2:GetParam(4), arg2:GetParam(5), arg2:GetParam(6), arg2:GetParam(7), nil, arg2:GetParam(8),
                    arg2:GetParam(9), arg2:GetParam(10), arg2:GetParam(11), nil)
