...
REGISTER_DBG_GOAL_PARAM(GOAL_EnemyBeforeAttack, 2, "?�T?A?N?V???????", 0)
...
Goal.Activate = function(arg0, arg1, arg2)
    ...
    arg2:AddSubGoal(GOAL_EnemyFlexibleApproach, arg2:GetLife(), f1_local0, f1_local1, f1_local11, f1_local12, f1_local3,
        f1_local4, f1_local5, f1_local6, f1_local7, f1_local8, f1_local9, f1_local10)
end
...
Goal.Activate = function(arg0, arg1, arg2)
            ...
            if arg1:GetAIAttackParam(f3_local13, AI_ATTACK_PARAM_TYPE__INTERVAL_EXEC) <= arg1:GetIdTimer(f3_local13 + 7100000) or arg1:GetNumber(60) == 1 then
                if not (arg1:GetAIAttackParam(f3_local13, AI_ATTACK_PARAM_TYPE__DOES_SELECT_ON_OUT_RANGE) ~= 1 or arg1:GetAIAttackParam(f3_local13, AI_ATTACK_PARAM_TYPE__DOES_SELECT_ON_INNER_RANGE) ~= 1) or arg1:GetAIAttackParam(f3_local13, AI_ATTACK_PARAM_TYPE__MIN_OPTIMAL_DISTANCE) <= f3_local2 and f3_local2 <= arg1:GetAIAttackParam(f3_local13, AI_ATTACK_PARAM_TYPE__MAX_OPTIMAL_DISTANCE) then
                    if arg1:IsOptimalAttackRangeH(f3_local0, f3_local13) then
                        local f3_local16 = arg1:GetIdTimer(f3_local13 + 7100000) -
                        arg1:GetAIAttackParam(f3_local13, AI_ATTACK_PARAM_TYPE__INTERVAL_EXEC)
                        ...
                        f3_local13 ..
                        "]?@" ..
                        arg1:GetAIAttackParam(f3_local13, AI_ATTACK_PARAM_TYPE__SELECTION_TENDENCY) ..
                        "?@?@" .. arg1:GetAIAttackParam(f3_local13, AI_ATTACK_PARAM_TYPE__MAX_OPTIMAL_DISTANCE))
                        f3_local12[f3_local13] = f3_local16 *
                        arg1:GetAIAttackParam(f3_local13, AI_ATTACK_PARAM_TYPE__SELECTION_TENDENCY) *
                        GetAttackRateByDist(arg0, arg1, arg2, f3_local13, GetDistPos(arg0, arg1, arg2, f3_local2))
                    else
    ...
    elseif f3_local14 == 7001 then
        ...
        f3_local16(f3_local17)
        arg2:AddSubGoal(GOAL_COMMON_FlexibleSideWayMove, arg2:GetLife(), arg1:GetRandam_Float(1, 100),
            arg1:GetRandam_Float(1, 100), f3_local0, f3_local7, arg1:GetRandam_Float(45, 240), f3_local4,
            arg1:GetAIAttackParam(7001, AI_ATTACK_PARAM_TYPE__MIN_OPTIMAL_DISTANCE),
            arg1:GetAIAttackParam(7001, AI_ATTACK_PARAM_TYPE__MAX_OPTIMAL_DISTANCE))
    elseif f3_local14 == 7002 then
        f3_local16 = print
        f3_local17 = "?yAfter Action?z"
        f3_local17 = f3_local17 .. "???"
        f3_local16(f3_local17)
        f3_local16 = arg2:AddSubGoal(GOAL_COMMON_LeaveTarget, arg2:GetLife(), f3_local0,
            arg1:GetAIAttackParam(7002, AI_ATTACK_PARAM_TYPE__MAX_OPTIMAL_DISTANCE), f3_local0, f3_local5, GuardID, 1,
            true)
    ...
    elseif f3_local14 == 7006 then
        ...
        f3_local17 = f3_local17 .. "???????"
        f3_local16(f3_local17)
        f3_local16 = arg2:AddSubGoal(GOAL_EnemyKeepDist, arg2:GetLife(), f3_local0, f3_local1,
            arg1:GetAIAttackParam(7006, AI_ATTACK_PARAM_TYPE__MIN_OPTIMAL_DISTANCE),
            arg1:GetAIAttackParam(7006, AI_ATTACK_PARAM_TYPE__MAX_OPTIMAL_DISTANCE), f3_local3, f3_local4, f3_local9, 0,
            f3_local8, f3_local9, f3_local10, f3_local7)
        f3_local16:SetFailedEndOption(AI_GOAL_FAILED_END_OPT__PARENT_NEXT_SUB_GOAL)
    elseif f3_local14 == 7007 then
        ...
        arg2:AddSubGoal(GOAL_EnemyFlexibleApproach, arg2:GetLife(), f3_local0, f3_local1, f3_local17, f3_local17, 0, 999,
            f3_local3, f3_local4, 0, 0, 0, 0)
...
Goal.Activate = function(arg0, arg1, arg2)
    ...
    elseif f5_local17 == 7002 then
        f5_local19 = arg2:AddSubGoal(GOAL_COMMON_LeaveTarget, arg2:GetLife(), f5_local0,
            arg1:GetAIAttackParam(7002, AI_ATTACK_PARAM_TYPE__MAX_OPTIMAL_DISTANCE), f5_local1, IsWalk, GuardID, 1, true)
    ...
    elseif f5_local17 == 7001 then
        arg2:SetNumber(1, 2)
        arg2:AddSubGoal(GOAL_COMMON_SidewayMove, arg2:GetLife(), f5_local0, arg1:GetRandam_Int(0, 1),
            arg1:GetRandam_Float(30, 60), true, true, GuardID, 1)
        return
    ...
    elseif f5_local17 == 7006 then
        local f5_local19 = arg2:AddSubGoal(GOAL_EnemyKeepDist, arg2:GetLife(), f5_local0, f5_local1, f5_local12,
            f5_local13, 50, f5_local3, 30, 0, arg0.EmergencyDist, arg0.EmergencyEscapeRate, arg0.EmergencyEscapeInterval,
            arg0.EmergencyCheckDist)
        f5_local19:SetFailedEndOption(AI_GOAL_FAILED_END_OPT__PARENT_NEXT_SUB_GOAL)
    else
...
Goal.Activate = function(arg0, arg1, arg2)
    ...
    f7_local1(f7_local0, f7_local2, f7_local3, f7_local4, f7_local5, f7_local6, f7_local7, f7_local8, f7_local9,
        f7_local10, f7_local11, f7_local12)
end
...
Goal.Activate = function(arg0, arg1, arg2)
    ...
    arg1:StartIdTimer(7110004)
    arg2:AddSubGoal(GOAL_COMMON_StepSafety, arg2:GetLife(), -1, -1, arg1:GetRandam_Float(1, 100),
        arg1:GetRandam_Float(1, 100), f12_local0, f12_local1, 0, true)
end
...
Goal.Activate = function(arg0, arg1, arg2)
    ...
    arg2:AddSubGoal(GOAL_COMMON_StepSafety, arg2:GetLife(), -1, arg1:GetRandam_Float(1, 100),
        arg1:GetRandam_Float(1, 100), arg1:GetRandam_Float(1, 100), f13_local0, f13_local1, 0, true)
end
...
Goal.Activate = function(arg0, arg1, arg2)
    ...
    arg2:AddSubGoal(GOAL_COMMON_ApproachTarget, arg2:GetLife(), POINT_EVENT, f17_local2, f17_local1, f17_local3,
        f17_local4)
end
