...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    f2_local0[1] = get_weight_base_on_cooldown(arg1, arg2, 3032, 5, f2_local0[1], 1)
    f2_local0[2] = get_weight_base_on_cooldown(arg1, arg2, 3003, 8, f2_local0[2], 1)
    f2_local0[3] = get_weight_base_on_cooldown(arg1, arg2, 3062, 8, f2_local0[3], 1)
    f2_local0[4] = get_weight_base_on_cooldown(arg1, arg2, 3067, 10, f2_local0[4], 1)
    f2_local0[5] = get_weight_base_on_cooldown(arg1, arg2, 3008, 15, f2_local0[5], 1)
    f2_local0[5] = get_weight_base_on_cooldown(arg1, arg2, 3034, 5, f2_local0[5], 1)
    f2_local0[6] = get_weight_base_on_cooldown(arg1, arg2, 3009, 8, f2_local0[6], 1)
    f2_local0[7] = get_weight_base_on_cooldown(arg1, arg2, 3010, 20, f2_local0[7], 1)
    f2_local0[7] = get_weight_base_on_cooldown(arg1, arg2, 3019, 20, f2_local0[7], 1)
    f2_local0[8] = get_weight_base_on_cooldown(arg1, arg2, 3011, 8, f2_local0[8], 1)
    f2_local0[9] = get_weight_base_on_cooldown(arg1, arg2, 3014, 10, f2_local0[9], 1)
    f2_local0[9] = get_weight_base_on_cooldown(arg1, arg2, 3035, 5, f2_local0[9], 1)
    f2_local0[10] = get_weight_base_on_cooldown(arg1, arg2, 3015, 20, f2_local0[10], 1)
    f2_local0[11] = get_weight_base_on_cooldown(arg1, arg2, 3017, 5, f2_local0[11], 1)
    f2_local0[12] = get_weight_base_on_cooldown(arg1, arg2, 3010, 15, f2_local0[12], 1)
    f2_local0[12] = get_weight_base_on_cooldown(arg1, arg2, 3019, 15, f2_local0[12], 1)
    f2_local0[13] = get_weight_base_on_cooldown(arg1, arg2, 3020, 15, f2_local0[13], 1)
    f2_local0[16] = get_weight_base_on_cooldown(arg1, arg2, 3001, 15, f2_local0[16], 1)
    f2_local0[17] = get_weight_base_on_cooldown(arg1, arg2, 3023, 15, f2_local0[17], 1)
    f2_local0[18] = get_weight_base_on_cooldown(arg1, arg2, 3019, 15, f2_local0[18], 1)
    f2_local0[19] = get_weight_base_on_cooldown(arg1, arg2, 3090, 3, f2_local0[19], 1)
    f2_local0[22] = get_weight_base_on_cooldown(arg1, arg2, 5202, 3, f2_local0[22], 1)
    f2_local0[22] = get_weight_base_on_cooldown(arg1, arg2, 5203, 3, f2_local0[22], 1)
    f2_local0[23] = get_weight_base_on_cooldown(arg1, arg2, 5010, 2, f2_local0[23], 1)
    f2_local0[24] = get_weight_base_on_cooldown(arg1, arg2, 5010, 2, f2_local0[24], 1)
    f2_local0[25] = get_weight_base_on_cooldown(arg1, arg2, 5010, 2, f2_local0[25], 1)
    f2_local0[30] = get_weight_base_on_cooldown(arg1, arg2, 3041, 4, f2_local0[30], 1)
    f2_local0[33] = get_weight_base_on_cooldown(arg1, arg2, 3026, 8, f2_local0[33], 1)
    f2_local0[33] = get_weight_base_on_cooldown(arg1, arg2, 3027, 8, f2_local0[33], 1)
    f2_local0[35] = get_weight_base_on_cooldown(arg1, arg2, 3026, 8, f2_local0[35], 1)
    f2_local0[35] = get_weight_base_on_cooldown(arg1, arg2, 3027, 8, f2_local0[35], 1)
    f2_local0[37] = get_weight_base_on_cooldown(arg1, arg2, 3062, 5, f2_local0[37], 1)
    f2_local0[37] = get_weight_base_on_cooldown(arg1, arg2, 6800, 5, f2_local0[37], 1)
...
Goal.Kengeki_Activate = function (arg0, arg1, arg2, arg3)
    local f48_local0 = get_kengeki_sp(arg1)
    ...
    f48_local1[2] = get_weight_base_on_cooldown(arg1, arg2, 3017, 3, f48_local1[2], 1)
    f48_local1[2] = get_weight_base_on_cooldown(arg1, arg2, 3058, 3, f48_local1[2], 1)
    f48_local1[3] = get_weight_base_on_cooldown(arg1, arg2, 3051, 5, f48_local1[3], 1)
    f48_local1[4] = get_weight_base_on_cooldown(arg1, arg2, 3055, 5, f48_local1[4], 1)
    f48_local1[5] = get_weight_base_on_cooldown(arg1, arg2, 3056, 5, f48_local1[5], 1)
    f48_local1[6] = get_weight_base_on_cooldown(arg1, arg2, 3019, 20, f48_local1[6], 1)
    f48_local1[7] = get_weight_base_on_cooldown(arg1, arg2, 3066, 2, f48_local1[7], 1)
    f48_local1[8] = get_weight_base_on_cooldown(arg1, arg2, 3060, 2, f48_local1[8], 1)
    f48_local1[9] = get_weight_base_on_cooldown(arg1, arg2, 3008, 5, f48_local1[9], 1)
    f48_local1[10] = get_weight_base_on_cooldown(arg1, arg2, 3018, 5, f48_local1[10], 1)
    f48_local1[11] = get_weight_base_on_cooldown(arg1, arg2, 3062, 2, f48_local1[11], 1)
    f48_local1[11] = get_weight_base_on_cooldown(arg1, arg2, 3066, 2, f48_local1[11], 1)
    f48_local1[12] = get_weight_base_on_cooldown(arg1, arg2, 3058, 2, f48_local1[12], 1)
    f48_local1[12] = get_weight_base_on_cooldown(arg1, arg2, 3060, 2, f48_local1[12], 1)
    f48_local1[12] = get_weight_base_on_cooldown(arg1, arg2, 3067, 2, f48_local1[12], 1)
    f48_local1[14] = get_weight_base_on_cooldown(arg1, arg2, 3033, 5, f48_local1[14], 1)
    f48_local1[16] = get_weight_base_on_cooldown(arg1, arg2, 3063, 2, f48_local1[16], 1)
    f48_local1[17] = get_weight_base_on_cooldown(arg1, arg2, 3068, 2, f48_local1[17], 1)
    f48_local1[18] = get_weight_base_on_cooldown(arg1, arg2, 3064, 2, f48_local1[18], 1)
    f48_local1[22] = get_weight_base_on_cooldown(arg1, arg2, 3028, 20, f48_local1[22], 1)
    f48_local1[41] = get_weight_base_on_cooldown(arg1, arg2, 3090, 4, f48_local1[41], 1)
