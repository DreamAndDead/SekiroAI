...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    f2_local0[3] = get_weight_base_on_cooldown(arg1, arg2, 3020, 10, f2_local0[3], 1)
    f2_local0[3] = get_weight_base_on_cooldown(arg1, arg2, 3021, 10, f2_local0[3], 1)
    f2_local0[3] = get_weight_base_on_cooldown(arg1, arg2, 3022, 10, f2_local0[3], 1)
    f2_local0[3] = get_weight_base_on_cooldown(arg1, arg2, 3023, 10, f2_local0[3], 1)
    f2_local0[4] = get_weight_base_on_cooldown(arg1, arg2, 3005, 4, f2_local0[4], 1)
    f2_local0[4] = get_weight_base_on_cooldown(arg1, arg2, 3006, 8, f2_local0[4], 1)
    f2_local0[4] = get_weight_base_on_cooldown(arg1, arg2, 3007, 8, f2_local0[4], 1)
    f2_local0[6] = get_weight_base_on_cooldown(arg1, arg2, 3003, 15, f2_local0[6], 1)
    f2_local0[7] = get_weight_base_on_cooldown(arg1, arg2, 3010, 15, f2_local0[7], 1)
    f2_local0[7] = get_weight_base_on_cooldown(arg1, arg2, 3064, 15, f2_local0[7], 1)
    f2_local0[8] = get_weight_base_on_cooldown(arg1, arg2, 3011, 10, f2_local0[8], 1)
    f2_local0[8] = get_weight_base_on_cooldown(arg1, arg2, 3012, 10, f2_local0[8], 1)
    f2_local0[9] = get_weight_base_on_cooldown(arg1, arg2, 3015, 10, f2_local0[9], 1)
    f2_local0[10] = get_weight_base_on_cooldown(arg1, arg2, 3010, 15, f2_local0[10], 1)
    f2_local0[10] = get_weight_base_on_cooldown(arg1, arg2, 3064, 15, f2_local0[10], 1)
    f2_local0[11] = get_weight_base_on_cooldown(arg1, arg2, 3020, 10, f2_local0[11], 1)
    f2_local0[11] = get_weight_base_on_cooldown(arg1, arg2, 3021, 10, f2_local0[11], 1)
    f2_local0[11] = get_weight_base_on_cooldown(arg1, arg2, 3022, 10, f2_local0[11], 1)
    f2_local0[11] = get_weight_base_on_cooldown(arg1, arg2, 3023, 10, f2_local0[11], 1)
    f2_local0[12] = get_weight_base_on_cooldown(arg1, arg2, 3018, 10, f2_local0[12], 1)
    f2_local0[15] = get_weight_base_on_cooldown(arg1, arg2, 3011, 10, f2_local0[15], 1)
    f2_local0[15] = get_weight_base_on_cooldown(arg1, arg2, 3012, 10, f2_local0[15], 1)
    f2_local0[17] = get_weight_base_on_cooldown(arg1, arg2, 3033, 16, f2_local0[17], 1)
    f2_local0[18] = get_weight_base_on_cooldown(arg1, arg2, 3018, 25, f2_local0[18], 1)
    f2_local0[19] = get_weight_base_on_cooldown(arg1, arg2, 3049, 10, f2_local0[19], 1)
    f2_local0[20] = get_weight_base_on_cooldown(arg1, arg2, 3010, 25, f2_local0[20], 1)
    f2_local0[23] = get_weight_base_on_cooldown(arg1, arg2, 405002, 5, f2_local0[23], 1)
    f2_local0[23] = get_weight_base_on_cooldown(arg1, arg2, 405003, 5, f2_local0[23], 1)
    f2_local0[30] = get_weight_base_on_cooldown(arg1, arg2, 5202, 5, f2_local0[30], 1)
    f2_local0[30] = get_weight_base_on_cooldown(arg1, arg2, 5203, 5, f2_local0[30], 1)
    f2_local0[31] = get_weight_base_on_cooldown(arg1, arg2, 405012, 3, f2_local0[31], 1)
    f2_local0[31] = get_weight_base_on_cooldown(arg1, arg2, 405013, 3, f2_local0[31], 1)
    f2_local0[32] = get_weight_base_on_cooldown(arg1, arg2, 3048, 10, f2_local0[32], 1)
    f2_local0[34] = get_weight_base_on_cooldown(arg1, arg2, 3093, 25, f2_local0[34], 1)
    f2_local0[35] = get_weight_base_on_cooldown(arg1, arg2, 3092, 10, f2_local0[35], 1)
    f2_local0[43] = get_weight_base_on_cooldown(arg1, arg2, 3048, 10, f2_local0[43], 1)
    f2_local0[44] = get_weight_base_on_cooldown(arg1, arg2, 3049, 10, f2_local0[44], 1)
    f2_local0[46] = get_weight_base_on_cooldown(arg1, arg2, 3044, 25, f2_local0[46], 1)
...
Goal.Kengeki_Activate = function (arg0, arg1, arg2, arg3)
    local f56_local0 = get_kengeki_sp(arg1)
    ...
    elseif f56_local0 == 200226 then
        f56_local1[8] = 200
        f56_local1[9] = 100
    elseif f56_local0 == SP_PARRY_COUNT_RIGHT then
    ...
    elseif f56_local0 == SP_PARRY_COUNT_LEFT then
        if f56_local4 >= 3 then
            f56_local1[26] = 100
        else
            f56_local1[2] = 100
    ...
    f56_local1[2] = get_weight_base_on_cooldown(arg1, arg2, 3066, 2, f56_local1[2], 1)
    f56_local1[3] = get_weight_base_on_cooldown(arg1, arg2, 3064, 5, f56_local1[3], 1)
    f56_local1[4] = get_weight_base_on_cooldown(arg1, arg2, 3068, 5, f56_local1[4], 1)
    f56_local1[6] = get_weight_base_on_cooldown(arg1, arg2, 3060, 2, f56_local1[6], 1)
    f56_local1[7] = get_weight_base_on_cooldown(arg1, arg2, 3065, 2, f56_local1[7], 1)
    f56_local1[12] = get_weight_base_on_cooldown(arg1, arg2, 3005, 4, f56_local1[12], 1)
    f56_local1[12] = get_weight_base_on_cooldown(arg1, arg2, 3006, 8, f56_local1[12], 1)
    f56_local1[12] = get_weight_base_on_cooldown(arg1, arg2, 3007, 8, f56_local1[12], 1)
    f56_local1[13] = get_weight_base_on_cooldown(arg1, arg2, 3024, 5, f56_local1[13], 1)
