...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    if arg1:HasSpecialEffectId(TARGET_SELF, 3150100) then
        if arg1:HasSpecialEffectId(TARGET_ENE_0, 108030) or arg1:HasSpecialEffectId(TARGET_ENE_0, SP_ENEMY_AI_REFERENCE_SHINOBI) or arg1:HasSpecialEffectId(TARGET_ENE_0, SP_DEAD) or arg1:HasSpecialEffectId(TARGET_ENE_0, SP_PRETEND_DEAD) or arg1:HasSpecialEffectId(TARGET_ENE_0, 110032) then
            f2_local0[17] = 100
    ...
    f2_local0[3] = get_weight_base_on_cooldown(arg1, arg2, 3002, 12, f2_local0[3], 1)
    f2_local0[10] = get_weight_base_on_cooldown(arg1, arg2, 3010, 5, f2_local0[10], 1)
    f2_local0[36] = get_weight_base_on_cooldown(arg1, arg2, 20000, 10, f2_local0[36], 0)
