...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    f2_local0[1] = get_weight_base_on_cooldown(arg1, arg2, 3000, 2, f2_local0[1], 1)
    f2_local0[1] = get_weight_base_on_cooldown(arg1, arg2, 3004, 2, f2_local0[1], 1)
    f2_local0[2] = get_weight_base_on_cooldown(arg1, arg2, 3001, 10, f2_local0[2], 1)
    f2_local0[3] = get_weight_base_on_cooldown(arg1, arg2, 3002, 6, f2_local0[3], 1)
    f2_local0[4] = get_weight_base_on_cooldown(arg1, arg2, 3003, 6, f2_local0[4], 1)
    f2_local0[6] = get_weight_base_on_cooldown(arg1, arg2, 3005, 10, f2_local0[6], 1)
    f2_local0[7] = get_weight_base_on_cooldown(arg1, arg2, 3006, 8, f2_local0[7], 1)
    f2_local0[8] = get_weight_base_on_cooldown(arg1, arg2, 3007, 5, f2_local0[8], 1)
    f2_local0[8] = get_weight_base_on_cooldown(arg1, arg2, 3008, 5, f2_local0[8], 1)
    f2_local0[9] = get_weight_base_on_cooldown(arg1, arg2, 3010, 5, f2_local0[9], 1)
    f2_local0[10] = get_weight_base_on_cooldown(arg1, arg2, 3011, 5, f2_local0[10], 1)
    f2_local0[24] = get_weight_base_on_cooldown(arg1, arg2, 5201, 3, f2_local0[24], 1)
...
Goal.Kengeki_Activate = function (arg0, arg1, arg2, arg3)
    ...
    if f24_local0 == SP_PARRY_COUNT_RIGHT then
    ...
    f24_local1[5] = get_weight_base_on_cooldown(arg1, arg2, 3002, 20, f24_local1[5], 1)
    f24_local1[6] = get_weight_base_on_cooldown(arg1, arg2, 3003, 20, f24_local1[6], 1)
    f24_local1[7] = get_weight_base_on_cooldown(arg1, arg2, 3006, 20, f24_local1[7], 1)
    f24_local1[8] = get_weight_base_on_cooldown(arg1, arg2, 3010, 5, f24_local1[8], 1)
    f24_local1[9] = get_weight_base_on_cooldown(arg1, arg2, 3011, 5, f24_local1[9], 1)
    f24_local1[24] = get_weight_base_on_cooldown(arg1, arg2, 5201, 8, f24_local1[24], 1)
